...
/**
 * This is the item provider adapter for a {@link essentialIFML.Core.ModuleDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModuleDefinitionItemProvider extends ModularizationElementItemProvider {
	...
	protected void addModulesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ModuleDefinition_modules_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ModuleDefinition_modules_feature",
								"_UI_ModuleDefinition_type"),
						CorePackage.Literals.MODULE_DEFINITION__MODULES, true, false, true, null, null, null));
	}
	...
	protected void addActivityConceptPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ModuleDefinition_activityConcept_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ModuleDefinition_activityConcept_feature",
								"_UI_ModuleDefinition_type"),
						CorePackage.Literals.MODULE_DEFINITION__ACTIVITY_CONCEPT, true, false, true, null, null, null));
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(CorePackage.Literals.MODULE_DEFINITION__INPUT_PORTS,
				CoreFactory.eINSTANCE.createPortDefinition()));

		newChildDescriptors.add(createChildParameter(CorePackage.Literals.MODULE_DEFINITION__OUTPUT_PORTS,
				CoreFactory.eINSTANCE.createPortDefinition()));

		newChildDescriptors
				.add(createChildParameter(CorePackage.Literals.MODULE_DEFINITION__INTERACTION_FLOW_MODEL_ELEMENT,
