...
/**
 * This is the item provider adapter for a {@link essentialIFML.Core.DynamicBehavior} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DynamicBehaviorItemProvider extends ContentBindingItemProvider {
	...
	protected void addBehavioralFeatureConceptPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_DynamicBehavior_behavioralFeatureConcept_feature",
						"_UI_DynamicBehavior_type"),
				CorePackage.Literals.DYNAMIC_BEHAVIOR__BEHAVIORAL_FEATURE_CONCEPT, true, false, true, null, null,
				null));
	}
	...
	protected void addBehaviorConceptPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_DynamicBehavior_behaviorConcept_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_DynamicBehavior_behaviorConcept_feature",
								"_UI_DynamicBehavior_type"),
						CorePackage.Literals.DYNAMIC_BEHAVIOR__BEHAVIOR_CONCEPT, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_DynamicBehavior_type")
