...
/**
 * This is the item provider adapter for a {@link essentialIFML.Core.InteractionFlowModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InteractionFlowModelItemProvider extends NamedElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CorePackage.Literals.INTERACTION_FLOW_MODEL__SCREEN_ZOOM);
			childrenFeatures.add(CorePackage.Literals.INTERACTION_FLOW_MODEL__CHANGE_BACKGROUND_COLOR);
			childrenFeatures.add(CorePackage.Literals.INTERACTION_FLOW_MODEL__NAV_BAR_CONTAINER);
			childrenFeatures.add(CorePackage.Literals.INTERACTION_FLOW_MODEL__SET_LANGUAGE);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_InteractionFlowModel_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(CorePackage.Literals.INTERACTION_FLOW_MODEL__INTERACTION_FLOW_MODEL_ELEMENTS,
		...
		newChildDescriptors
				.add(createChildParameter(CorePackage.Literals.INTERACTION_FLOW_MODEL__INTERACTION_FLOW_MODEL_ELEMENTS,
						CoreFactory.eINSTANCE.createScreenZoom()));

		newChildDescriptors
				.add(createChildParameter(CorePackage.Literals.INTERACTION_FLOW_MODEL__INTERACTION_FLOW_MODEL_ELEMENTS,
						CoreFactory.eINSTANCE.createLightBackgroundColor()));

		newChildDescriptors
				.add(createChildParameter(CorePackage.Literals.INTERACTION_FLOW_MODEL__INTERACTION_FLOW_MODEL_ELEMENTS,
						CoreFactory.eINSTANCE.createLanguage()));
		...
		newChildDescriptors.add(createChildParameter(CorePackage.Literals.INTERACTION_FLOW_MODEL__SCREEN_ZOOM,
				CoreFactory.eINSTANCE.createScreenZoom()));

		newChildDescriptors
				.add(createChildParameter(CorePackage.Literals.INTERACTION_FLOW_MODEL__CHANGE_BACKGROUND_COLOR,
						CoreFactory.eINSTANCE.createLightBackgroundColor()));

		newChildDescriptors.add(createChildParameter(CorePackage.Literals.INTERACTION_FLOW_MODEL__NAV_BAR_CONTAINER,
				CoreFactory.eINSTANCE.createViewContainer()));
		...
		newChildDescriptors.add(createChildParameter(CorePackage.Literals.INTERACTION_FLOW_MODEL__SET_LANGUAGE,
				CoreFactory.eINSTANCE.createLanguage()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify = childFeature == CorePackage.Literals.ELEMENT__CONSTRAINTS
				|| childFeature == CorePackage.Literals.INTERACTION_FLOW_MODEL__INTERACTION_FLOW_MODEL_ELEMENTS
				|| childFeature == CorePackage.Literals.INTERACTION_FLOW_MODEL__NAV_BAR_CONTAINER
				|| childFeature == CorePackage.Literals.INTERACTION_FLOW_MODEL__SCREEN_ZOOM
				|| childFeature == CorePackage.Literals.INTERACTION_FLOW_MODEL__CHANGE_BACKGROUND_COLOR
				|| childFeature == CorePackage.Literals.INTERACTION_FLOW_MODEL__SET_LANGUAGE;
