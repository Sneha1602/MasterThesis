...
/**
 * This is the item provider adapter for a {@link essentialIFML.Core.ViewElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ViewElementItemProvider extends InteractionFlowElementItemProvider {
	...
	protected void addActivationExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ViewElement_activationExpression_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ViewElement_activationExpression_feature",
								"_UI_ViewElement_type"),
						CorePackage.Literals.VIEW_ELEMENT__ACTIVATION_EXPRESSION, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_ViewElement_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(CorePackage.Literals.VIEW_ELEMENT__VIEW_ELEMENT_EVENTS,
