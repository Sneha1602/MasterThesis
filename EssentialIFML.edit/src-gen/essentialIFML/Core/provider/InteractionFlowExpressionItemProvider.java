...
/**
 * This is the item provider adapter for a {@link essentialIFML.Core.InteractionFlowExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InteractionFlowExpressionItemProvider extends ExpressionItemProvider {
	...
	protected void addInteractionFlowPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_InteractionFlowExpression_interactionFlow_feature",
						"_UI_InteractionFlowExpression_type"),
				CorePackage.Literals.INTERACTION_FLOW_EXPRESSION__INTERACTION_FLOW, true, false, true, null, null,
				null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_InteractionFlowExpression_type")
