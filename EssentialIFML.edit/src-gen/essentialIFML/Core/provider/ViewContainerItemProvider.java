...
/**
 * This is the item provider adapter for a {@link essentialIFML.Core.ViewContainer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ViewContainerItemProvider extends ViewElementItemProvider {
	...
	protected void addIsLandmarkPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ViewContainer_isLandmark_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ViewContainer_isLandmark_feature",
								"_UI_ViewContainer_type"),
						CorePackage.Literals.VIEW_CONTAINER__IS_LANDMARK, true, false, false,
	...
	protected void addIsDefaultPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ViewContainer_isDefault_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ViewContainer_isDefault_feature",
								"_UI_ViewContainer_type"),
						CorePackage.Literals.VIEW_CONTAINER__IS_DEFAULT, true, false, false,
						ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
	...
	protected void addIsXORPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ViewContainer_isXOR_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ViewContainer_isXOR_feature",
								"_UI_ViewContainer_type"),
						CorePackage.Literals.VIEW_CONTAINER__IS_XOR, true, false, false,
						ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_ViewContainer_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(CorePackage.Literals.VIEW_CONTAINER__VIEW_ELEMENTS,
		...
		newChildDescriptors.add(createChildParameter(CorePackage.Literals.VIEW_CONTAINER__ACTIONS,
