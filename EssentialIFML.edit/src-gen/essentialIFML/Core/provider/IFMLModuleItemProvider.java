...
/**
 * This is the item provider adapter for a {@link essentialIFML.Core.IFMLModule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IFMLModuleItemProvider extends NamedElementItemProvider {
	...
	protected void addInInteractionFlowsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_InteractionFlowElement_inInteractionFlows_feature",
						"_UI_InteractionFlowElement_type"),
				CorePackage.Literals.INTERACTION_FLOW_ELEMENT__IN_INTERACTION_FLOWS, true, false, true, null, null,
				null));
	}
	...
	protected void addModuleDefinitionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_IFMLModule_moduleDefinition_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_IFMLModule_moduleDefinition_feature",
								"_UI_IFMLModule_type"),
						CorePackage.Literals.IFML_MODULE__MODULE_DEFINITION, true, false, true, null, null, null));
	}
	...
	protected void addPortsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_IFMLModule_ports_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_IFMLModule_ports_feature",
								"_UI_IFMLModule_type"),
						CorePackage.Literals.IFML_MODULE__PORTS, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_IFMLModule_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(CorePackage.Literals.INTERACTION_FLOW_ELEMENT__PARAMETERS,
		...
		newChildDescriptors
				.add(createChildParameter(CorePackage.Literals.INTERACTION_FLOW_ELEMENT__OUT_INTERACTION_FLOWS,
