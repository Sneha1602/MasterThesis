...
import essentialIFML.Core.provider.ViewContainerItemProvider;
...
/**
 * This is the item provider adapter for a {@link essentialIFML.Extensions.IFMLWindow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IFMLWindowItemProvider extends ViewContainerItemProvider {
	...
	protected void addIsModalPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_IFMLWindow_isModal_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_IFMLWindow_isModal_feature",
								"_UI_IFMLWindow_type"),
						ExtensionsPackage.Literals.IFML_WINDOW__IS_MODAL, true, false, false,
	...
	protected void addIsNewWindowPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_IFMLWindow_isNewWindow_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_IFMLWindow_isNewWindow_feature",
								"_UI_IFMLWindow_type"),
						ExtensionsPackage.Literals.IFML_WINDOW__IS_NEW_WINDOW, true, false, false,
						ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_IFMLWindow_type")
