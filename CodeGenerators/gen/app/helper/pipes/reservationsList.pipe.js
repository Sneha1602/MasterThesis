...
var ReservationsListFilter = (function () {
    function ReservationsListFilter() {
    }
    ReservationsListFilter.prototype.transform = function (items, filterBy) {
        ...
        if (items != undefined) {
            if (filterBy === undefined) {
                ...
                if (filterBy['*'] != undefined) {
                    ...
                    return items.filter(function (item) { return item.reservedBy.studentId.toString().toLowerCase().indexOf(filterBy['*'].toLowerCase()) !== -1 ||
    ...
    ReservationsListFilter = __decorate([
        core_1.Pipe({ name: 'reservationsListFilter' }), 
        __metadata('design:paramtypes', [])
    ], ReservationsListFilter);
    return ReservationsListFilter;
}());
exports.ReservationsListFilter = ReservationsListFilter;
//# sourceMappingURL=reservationsList.pipe.js.map