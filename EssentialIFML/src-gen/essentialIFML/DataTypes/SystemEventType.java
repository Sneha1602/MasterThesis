 ...
 * <!-- end-user-doc -->
 * @see essentialIFML.DataTypes.DataTypesPackage#getSystemEventType()
 * @model
 * @generated
 */
public enum SystemEventType implements Enumerator {
	 ...
	 * @generated
	 */
	private static final SystemEventType[] VALUES_ARRAY = new SystemEventType[] { TIME, SPECIAL_CONDITION,
			ACTION_COMPLETION, };
