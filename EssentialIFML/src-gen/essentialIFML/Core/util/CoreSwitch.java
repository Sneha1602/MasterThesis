...
public class CoreSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case CorePackage.INTERACTION_FLOW: {
			...
			if (result == null)
				result = caseInteractionFlowModelElement(interactionFlow);
			if (result == null)
				result = caseElement(interactionFlow);
			if (result == null)
		...
		case CorePackage.INTERACTION_FLOW_EXPRESSION: {
			...
			if (result == null)
				result = caseExpression(interactionFlowExpression);
			if (result == null)
				result = caseInteractionFlowModelElement(interactionFlowExpression);
			if (result == null)
				result = caseElement(interactionFlowExpression);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.SYSTEM_EVENT: {
			...
			if (result == null)
				result = caseCatchingEvent(systemEvent);
			if (result == null)
				result = caseEvent(systemEvent);
			if (result == null)
				result = caseInteractionFlowElement(systemEvent);
			if (result == null)
				result = caseNamedElement(systemEvent);
			if (result == null)
				result = caseInteractionFlowModelElement(systemEvent);
			if (result == null)
				result = caseElement(systemEvent);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.PARAMETER_BINDING: {
			...
			if (result == null)
				result = caseElement(parameterBinding);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.ACTION_EVENT: {
			...
			if (result == null)
				result = caseNamedElement(actionEvent);
			if (result == null)
				result = caseInteractionFlowModelElement(actionEvent);
			if (result == null)
				result = caseElement(actionEvent);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.DOMAIN_MODEL: {
			...
			if (result == null)
				result = caseNamedElement(domainModel);
			if (result == null)
				result = caseElement(domainModel);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case CorePackage.PORT_DEFINITION: {
			...
			if (result == null)
				result = caseNamedElement(portDefinition);
			if (result == null)
				result = caseInteractionFlowModelElement(portDefinition);
			if (result == null)
				result = caseElement(portDefinition);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.CONTENT_BINDING: {
			...
			if (result == null)
				result = caseViewComponentPart(contentBinding);
			if (result == null)
				result = caseInteractionFlowElement(contentBinding);
			if (result == null)
				result = caseNamedElement(contentBinding);
			if (result == null)
				result = caseInteractionFlowModelElement(contentBinding);
			if (result == null)
				result = caseElement(contentBinding);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.VIEW_ELEMENT: {
			...
			if (result == null)
				result = caseNamedElement(viewElement);
			if (result == null)
				result = caseInteractionFlowModelElement(viewElement);
			if (result == null)
				result = caseElement(viewElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.EXPRESSION: {
			...
			if (result == null)
				result = caseInteractionFlowModelElement(expression);
			if (result == null)
		...
		case CorePackage.DYNAMIC_BEHAVIOR: {
			...
			if (result == null)
				result = caseContentBinding(dynamicBehavior);
			if (result == null)
				result = caseViewComponentPart(dynamicBehavior);
			if (result == null)
				result = caseInteractionFlowElement(dynamicBehavior);
			if (result == null)
				result = caseNamedElement(dynamicBehavior);
			if (result == null)
				result = caseInteractionFlowModelElement(dynamicBehavior);
			if (result == null)
				result = caseElement(dynamicBehavior);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.VIEWPOINT: {
			...
			if (result == null)
				result = caseNamedElement(viewpoint);
			if (result == null)
				result = caseElement(viewpoint);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.DATA_FLOW: {
			...
			if (result == null)
				result = caseInteractionFlow(dataFlow);
			if (result == null)
				result = caseInteractionFlowModelElement(dataFlow);
			if (result == null)
				result = caseElement(dataFlow);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.VIEW_COMPONENT_PART: {
			...
			if (result == null)
				result = caseNamedElement(viewComponentPart);
			if (result == null)
				result = caseInteractionFlowModelElement(viewComponentPart);
			if (result == null)
				result = caseElement(viewComponentPart);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.VIEW_CONTAINER: {
			...
			if (result == null)
				result = caseNamedElement(viewContainer);
			if (result == null)
				result = caseInteractionFlowModelElement(viewContainer);
			if (result == null)
				result = caseElement(viewContainer);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.ACTIVATION_EXPRESSION: {
			...
			if (result == null)
				result = caseBooleanExpression(activationExpression);
			if (result == null)
				result = caseExpression(activationExpression);
			if (result == null)
				result = caseInteractionFlowModelElement(activationExpression);
			if (result == null)
				result = caseElement(activationExpression);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.INTERACTION_FLOW_MODEL: {
			...
			if (result == null)
				result = caseNamedElement(interactionFlowModel);
			if (result == null)
				result = caseElement(interactionFlowModel);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.CONTEXT_DIMENSION: {
			...
			if (result == null)
				result = caseNamedElement(contextDimension);
			if (result == null)
				result = caseElement(contextDimension);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.ESSENTIAL_IFML_MODEL: {
			EssentialIFMLModel essentialIFMLModel = (EssentialIFMLModel) theEObject;
			T result = caseEssentialIFMLModel(essentialIFMLModel);
			if (result == null)
				result = caseNamedElement(essentialIFMLModel);
			if (result == null)
				result = caseElement(essentialIFMLModel);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.MODULE_DEFINITION: {
			...
			if (result == null)
				result = caseModularizationElement(moduleDefinition);
			if (result == null)
				result = caseNamedElement(moduleDefinition);
			if (result == null)
				result = caseInteractionFlowModelElement(moduleDefinition);
			if (result == null)
				result = caseElement(moduleDefinition);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.BOOLEAN_EXPRESSION: {
			...
			if (result == null)
				result = caseInteractionFlowModelElement(booleanExpression);
			if (result == null)
		...
		case CorePackage.INTERACTION_FLOW_ELEMENT: {
			...
			if (result == null)
				result = caseNamedElement(interactionFlowElement);
			if (result == null)
				result = caseInteractionFlowModelElement(interactionFlowElement);
			if (result == null)
				result = caseElement(interactionFlowElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.IFML_ACTION: {
			...
			if (result == null)
				result = caseInteractionFlowElement(ifmlAction);
			if (result == null)
				result = caseNamedElement(ifmlAction);
			if (result == null)
				result = caseInteractionFlowModelElement(ifmlAction);
			if (result == null)
				result = caseElement(ifmlAction);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.NAVIGATION_FLOW: {
			...
			if (result == null)
				result = caseInteractionFlow(navigationFlow);
			if (result == null)
				result = caseInteractionFlowModelElement(navigationFlow);
			if (result == null)
				result = caseElement(navigationFlow);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.PARAMETER_BINDING_GROUP: {
			...
			if (result == null)
				result = caseElement(parameterBindingGroup);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case CorePackage.CONSTRAINT: {
			...
			if (result == null)
				result = caseBooleanExpression(constraint);
			if (result == null)
				result = caseExpression(constraint);
			if (result == null)
				result = caseInteractionFlowModelElement(constraint);
			if (result == null)
		...
		case CorePackage.VIEW_COMPONENT: {
			...
			if (result == null)
				result = caseNamedElement(viewComponent);
			if (result == null)
				result = caseInteractionFlowModelElement(viewComponent);
			if (result == null)
				result = caseElement(viewComponent);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.IFML_PARAMETER: {
			...
			if (result == null)
				result = caseInteractionFlowModelElement(ifmlParameter);
			if (result == null)
				result = caseNamedElement(ifmlParameter);
			if (result == null)
				result = caseElement(ifmlParameter);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.DATA_BINDING: {
			...
			if (result == null)
				result = caseContentBinding(dataBinding);
			if (result == null)
				result = caseViewComponentPart(dataBinding);
			if (result == null)
				result = caseInteractionFlowElement(dataBinding);
			if (result == null)
				result = caseNamedElement(dataBinding);
			if (result == null)
				result = caseInteractionFlowModelElement(dataBinding);
			if (result == null)
				result = caseElement(dataBinding);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.CONDITIONAL_EXPRESSION: {
			...
			if (result == null)
				result = caseViewComponentPart(conditionalExpression);
			if (result == null)
				result = caseInteractionFlowElement(conditionalExpression);
			if (result == null)
				result = caseInteractionFlowModelElement(conditionalExpression);
			if (result == null)
				result = caseNamedElement(conditionalExpression);
			if (result == null)
				result = caseElement(conditionalExpression);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case CorePackage.VISUALIZATION_ATTRIBUTE: {
			...
			if (result == null)
				result = caseViewComponentPart(visualizationAttribute);
			if (result == null)
				result = caseInteractionFlowElement(visualizationAttribute);
			if (result == null)
				result = caseNamedElement(visualizationAttribute);
			if (result == null)
				result = caseInteractionFlowModelElement(visualizationAttribute);
			if (result == null)
				result = caseElement(visualizationAttribute);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case CorePackage.INTERACTION_FLOW_MODEL_ELEMENT: {
			...
			if (result == null)
				result = caseElement(interactionFlowModelElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.VIEW_ELEMENT_EVENT: {
			...
			if (result == null)
				result = caseNamedElement(viewElementEvent);
			if (result == null)
				result = caseInteractionFlowModelElement(viewElementEvent);
			if (result == null)
				result = caseElement(viewElementEvent);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case CorePackage.MODULE_PACKAGE: {
			...
			if (result == null)
				result = caseModularizationElement(modulePackage);
			if (result == null)
				result = caseNamedElement(modulePackage);
			if (result == null)
				result = caseInteractionFlowModelElement(modulePackage);
			if (result == null)
				result = caseElement(modulePackage);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.MODULARIZATION_ELEMENT: {
			...
			if (result == null)
				result = caseNamedElement(modularizationElement);
			if (result == null)
				result = caseInteractionFlowModelElement(modularizationElement);
			if (result == null)
				result = caseElement(modularizationElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.IFML_MODULE: {
			...
			if (result == null)
				result = caseInteractionFlowElement(ifmlModule);
			if (result == null)
				result = caseNamedElement(ifmlModule);
			if (result == null)
				result = caseInteractionFlowModelElement(ifmlModule);
			if (result == null)
				result = caseElement(ifmlModule);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.IFML_PORT: {
			...
			if (result == null)
				result = caseInteractionFlowElement(ifmlPort);
			if (result == null)
				result = caseNamedElement(ifmlPort);
			if (result == null)
				result = caseInteractionFlowModelElement(ifmlPort);
			if (result == null)
				result = caseElement(ifmlPort);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.CATCHING_EVENT: {
			...
			if (result == null)
				result = caseNamedElement(catchingEvent);
			if (result == null)
				result = caseInteractionFlowModelElement(catchingEvent);
			if (result == null)
				result = caseElement(catchingEvent);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.THROWING_EVENT: {
			...
			if (result == null)
				result = caseNamedElement(throwingEvent);
			if (result == null)
				result = caseInteractionFlowModelElement(throwingEvent);
			if (result == null)
				result = caseElement(throwingEvent);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.BPMN_ACTIVITY_CONCEPT: {
			...
			if (result == null)
				result = caseActivityConcept(bpmnActivityConcept);
			if (result == null)
				result = caseNamedElement(bpmnActivityConcept);
			if (result == null)
				result = caseElement(bpmnActivityConcept);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.CONTEXT_VARIABLE: {
			...
			if (result == null)
				result = caseNamedElement(contextVariable);
			if (result == null)
				result = caseElement(contextVariable);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.SIMPLE_CONTEXT_VARIABLE: {
			...
			if (result == null)
				result = caseContextVariable(simpleContextVariable);
			if (result == null)
				result = caseNamedElement(simpleContextVariable);
			if (result == null)
				result = caseElement(simpleContextVariable);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.DATA_CONTEXT_VARIABLE: {
			...
			if (result == null)
				result = caseContextVariable(dataContextVariable);
			if (result == null)
				result = caseNamedElement(dataContextVariable);
			if (result == null)
				result = caseElement(dataContextVariable);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.DOMAIN_CONCEPT: {
			...
			if (result == null)
				result = caseDomainElement(domainConcept);
			if (result == null)
				result = caseNamedElement(domainConcept);
			if (result == null)
				result = caseElement(domainConcept);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.FEATURE_CONCEPT: {
			...
			if (result == null)
				result = caseDomainElement(featureConcept);
			if (result == null)
				result = caseNamedElement(featureConcept);
			if (result == null)
				result = caseElement(featureConcept);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.BEHAVIOR_CONCEPT: {
			...
			if (result == null)
				result = caseDomainElement(behaviorConcept);
			if (result == null)
				result = caseNamedElement(behaviorConcept);
			if (result == null)
				result = caseElement(behaviorConcept);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.BEHAVIORAL_FEATURE_CONCEPT: {
			...
			if (result == null)
				result = caseDomainElement(behavioralFeatureConcept);
			if (result == null)
				result = caseNamedElement(behavioralFeatureConcept);
			if (result == null)
				result = caseElement(behavioralFeatureConcept);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.UML_BEHAVIOR: {
			...
			if (result == null)
				result = caseBehaviorConcept(umlBehavior);
			if (result == null)
				result = caseDomainElement(umlBehavior);
			if (result == null)
				result = caseNamedElement(umlBehavior);
			if (result == null)
				result = caseElement(umlBehavior);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.UML_BEHAVIORAL_FEATURE: {
			...
			if (result == null)
				result = caseBehavioralFeatureConcept(umlBehavioralFeature);
			if (result == null)
				result = caseDomainElement(umlBehavioralFeature);
			if (result == null)
				result = caseNamedElement(umlBehavioralFeature);
			if (result == null)
				result = caseElement(umlBehavioralFeature);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.UML_DOMAIN_CONCEPT: {
			...
			if (result == null)
				result = caseDomainConcept(umlDomainConcept);
			if (result == null)
				result = caseDomainElement(umlDomainConcept);
			if (result == null)
				result = caseNamedElement(umlDomainConcept);
			if (result == null)
				result = caseElement(umlDomainConcept);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.UML_STRUCTURAL_FEATURE: {
			...
			if (result == null)
				result = caseFeatureConcept(umlStructuralFeature);
			if (result == null)
				result = caseDomainElement(umlStructuralFeature);
			if (result == null)
				result = caseNamedElement(umlStructuralFeature);
			if (result == null)
				result = caseElement(umlStructuralFeature);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.ACTIVITY_CONCEPT: {
			...
			if (result == null)
				result = caseNamedElement(activityConcept);
			if (result == null)
				result = caseElement(activityConcept);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.DOMAIN_ELEMENT: {
			...
			if (result == null)
				result = caseNamedElement(domainElement);
			if (result == null)
				result = caseElement(domainElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.SCREEN_ZOOM: {
			ScreenZoom screenZoom = (ScreenZoom) theEObject;
			T result = caseScreenZoom(screenZoom);
			if (result == null)
				result = caseNamedElement(screenZoom);
			if (result == null)
				result = caseInteractionFlowModelElement(screenZoom);
			if (result == null)
				result = caseElement(screenZoom);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.LIGHT_BACKGROUND_COLOR: {
			...
			if (result == null)
				result = caseNamedElement(lightBackgroundColor);
			if (result == null)
				result = caseInteractionFlowModelElement(lightBackgroundColor);
			if (result == null)
				result = caseElement(lightBackgroundColor);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CorePackage.LANGUAGE: {
			Language language = (Language) theEObject;
			T result = caseLanguage(language);
			if (result == null)
				result = caseNamedElement(language);
			if (result == null)
				result = caseInteractionFlowModelElement(language);
			if (result == null)
				result = caseElement(language);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Essential IFML Model</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Essential IFML Model</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Screen Zoom</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Screen Zoom</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseScreenZoom(ScreenZoom object) {
		return null;
	}
