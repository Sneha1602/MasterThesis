 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.InteractionFlow#getParameterBindingGroup <em>Parameter Binding Group</em>}</li>
 *   <li>{@link essentialIFML.Core.InteractionFlow#getSourceInteractionFlowElement <em>Source Interaction Flow Element</em>}</li>
 *   <li>{@link essentialIFML.Core.InteractionFlow#getTargetInteractionFlowElement <em>Target Interaction Flow Element</em>}</li>
 * </ul>
 *
 * @see essentialIFML.Core.CorePackage#getInteractionFlow()
 * @model abstract="true"
 * @generated
 */
public interface InteractionFlow extends InteractionFlowModelElement {
	 ...
	 * @see essentialIFML.Core.CorePackage#getInteractionFlow_ParameterBindingGroup()
	...
	/**
	 * Sets the value of the '{@link essentialIFML.Core.InteractionFlow#getParameterBindingGroup <em>Parameter Binding Group</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link essentialIFML.Core.InteractionFlowElement#getOutInteractionFlows <em>Out Interaction Flows</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see essentialIFML.Core.CorePackage#getInteractionFlow_SourceInteractionFlowElement()
	...
	/**
	 * Sets the value of the '{@link essentialIFML.Core.InteractionFlow#getSourceInteractionFlowElement <em>Source Interaction Flow Element</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link essentialIFML.Core.InteractionFlowElement#getInInteractionFlows <em>In Interaction Flows</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see essentialIFML.Core.CorePackage#getInteractionFlow_TargetInteractionFlowElement()
	...
	/**
	 * Sets the value of the '{@link essentialIFML.Core.InteractionFlow#getTargetInteractionFlowElement <em>Target Interaction Flow Element</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
