 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.ViewComponentImpl#getViewComponentParts <em>View Component Parts</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ViewComponentImpl extends ViewElementImpl implements ViewComponent {
	...
	public EList<ViewComponentPart> getViewComponentParts() {
		if (viewComponentParts == null) {
			viewComponentParts = new EObjectContainmentEList<ViewComponentPart>(ViewComponentPart.class, this,
					CorePackage.VIEW_COMPONENT__VIEW_COMPONENT_PARTS);
		}
