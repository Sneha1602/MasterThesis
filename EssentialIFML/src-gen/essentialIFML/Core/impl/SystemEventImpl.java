 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.SystemEventImpl#getTriggeringExpressions <em>Triggering Expressions</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.SystemEventImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SystemEventImpl extends CatchingEventImpl implements SystemEvent {
	...
	public EList<Expression> getTriggeringExpressions() {
		if (triggeringExpressions == null) {
			triggeringExpressions = new EObjectContainmentEList<Expression>(Expression.class, this,
					CorePackage.SYSTEM_EVENT__TRIGGERING_EXPRESSIONS);
		}
