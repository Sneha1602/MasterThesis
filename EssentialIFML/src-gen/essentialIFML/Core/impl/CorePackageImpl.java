...
import essentialIFML.Core.ActionEvent;
import essentialIFML.Core.ActivationExpression;
import essentialIFML.Core.ActivityConcept;
import essentialIFML.Core.Annotation;
import essentialIFML.Core.BPMNActivityConcept;
import essentialIFML.Core.BehaviorConcept;
import essentialIFML.Core.BehavioralFeatureConcept;
import essentialIFML.Core.BooleanExpression;
import essentialIFML.Core.CatchingEvent;
import essentialIFML.Core.ConditionalExpression;
import essentialIFML.Core.Constraint;
import essentialIFML.Core.ContentBinding;
import essentialIFML.Core.Context;
import essentialIFML.Core.ContextDimension;
import essentialIFML.Core.ContextVariable;
import essentialIFML.Core.CoreFactory;
import essentialIFML.Core.CorePackage;
import essentialIFML.Core.DataBinding;
import essentialIFML.Core.DataContextVariable;
import essentialIFML.Core.DataFlow;
import essentialIFML.Core.DomainConcept;
import essentialIFML.Core.DomainElement;
import essentialIFML.Core.DomainModel;
import essentialIFML.Core.DynamicBehavior;
...
import essentialIFML.Core.IFMLModule;
import essentialIFML.Core.IFMLParameter;
import essentialIFML.Core.IFMLPort;
import essentialIFML.Core.InteractionFlow;
import essentialIFML.Core.InteractionFlowElement;
import essentialIFML.Core.InteractionFlowExpression;
...
import essentialIFML.Core.ModularizationElement;
import essentialIFML.Core.ModuleDefinition;
import essentialIFML.Core.ModulePackage;
import essentialIFML.Core.NamedElement;
import essentialIFML.Core.NavigationFlow;
import essentialIFML.Core.ParameterBinding;
import essentialIFML.Core.ParameterBindingGroup;
import essentialIFML.Core.PortDefinition;
import essentialIFML.Core.ScreenZoom;
import essentialIFML.Core.SimpleContextVariable;
import essentialIFML.Core.SystemEvent;
import essentialIFML.Core.ThrowingEvent;
import essentialIFML.Core.UMLBehavior;
import essentialIFML.Core.UMLBehavioralFeature;
import essentialIFML.Core.UMLDomainConcept;
import essentialIFML.Core.UMLStructuralFeature;
...
import essentialIFML.Core.Viewpoint;
import essentialIFML.Core.VisualizationAttribute;

import essentialIFML.DataTypes.DataTypesPackage;

import essentialIFML.DataTypes.impl.DataTypesPackageImpl;

import essentialIFML.Extensions.ExtensionsPackage;

import essentialIFML.Extensions.impl.ExtensionsPackageImpl;
...
public class CorePackageImpl extends EPackageImpl implements CorePackage {
	 ...
	 * @generated
	 */
	private EClass screenZoomEClass = null;
	 ...
	 * @see essentialIFML.Core.CorePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static CorePackage init() {
		...
		DataTypesPackageImpl theDataTypesPackage = (DataTypesPackageImpl) (EPackage.Registry.INSTANCE
				.getEPackage(DataTypesPackage.eNS_URI) instanceof DataTypesPackageImpl
						? EPackage.Registry.INSTANCE.getEPackage(DataTypesPackage.eNS_URI)
						: DataTypesPackage.eINSTANCE);
		ExtensionsPackageImpl theExtensionsPackage = (ExtensionsPackageImpl) (EPackage.Registry.INSTANCE
				.getEPackage(ExtensionsPackage.eNS_URI) instanceof ExtensionsPackageImpl
						? EPackage.Registry.INSTANCE.getEPackage(ExtensionsPackage.eNS_URI)
	 ...
	 * @generated
	 */
	public EReference getInteractionFlowModel_ScreenZoom() {
		return (EReference) interactionFlowModelEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getInteractionFlowModel_ChangeBackgroundColor() {
		return (EReference) interactionFlowModelEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getInteractionFlowModel_NavBarContainer() {
		return (EReference) interactionFlowModelEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getInteractionFlowModel_SetLanguage() {
		return (EReference) interactionFlowModelEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getEssentialIFMLModel_InteractionFlowModel() {
	 ...
	 * @generated
	 */
	public EReference getEssentialIFMLModel_DomainModel() {
	 ...
	 * @generated
	 */
	public EReference getEssentialIFMLModel_InteractionFlowModelViewpoint() {
	 ...
	 * @generated
	 */
	public EClass getScreenZoom() {
		return screenZoomEClass;
	}
	...
	public void createPackageContents() {
		...
		createEReference(interactionFlowModelEClass, INTERACTION_FLOW_MODEL__SCREEN_ZOOM);
		createEReference(interactionFlowModelEClass, INTERACTION_FLOW_MODEL__CHANGE_BACKGROUND_COLOR);
		createEReference(interactionFlowModelEClass, INTERACTION_FLOW_MODEL__NAV_BAR_CONTAINER);
		createEReference(interactionFlowModelEClass, INTERACTION_FLOW_MODEL__SET_LANGUAGE);

		contextDimensionEClass = createEClass(CONTEXT_DIMENSION);

		essentialIFMLModelEClass = createEClass(ESSENTIAL_IFML_MODEL);
		createEReference(essentialIFMLModelEClass, ESSENTIAL_IFML_MODEL__INTERACTION_FLOW_MODEL);
		createEReference(essentialIFMLModelEClass, ESSENTIAL_IFML_MODEL__DOMAIN_MODEL);
		createEReference(essentialIFMLModelEClass, ESSENTIAL_IFML_MODEL__INTERACTION_FLOW_MODEL_VIEWPOINT);
		...
		screenZoomEClass = createEClass(SCREEN_ZOOM);
	...
	public void initializePackageContents() {
		...
		screenZoomEClass.getESuperTypes().add(this.getNamedElement());
		screenZoomEClass.getESuperTypes().add(this.getInteractionFlowModelElement());
		lightBackgroundColorEClass.getESuperTypes().add(this.getNamedElement());
		lightBackgroundColorEClass.getESuperTypes().add(this.getInteractionFlowModelElement());
		languageEClass.getESuperTypes().add(this.getNamedElement());
		languageEClass.getESuperTypes().add(this.getInteractionFlowModelElement());

		// Initialize classes, features, and operations; add parameters
		initEClass(interactionFlowEClass, InteractionFlow.class, "InteractionFlow", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getInteractionFlow_ParameterBindingGroup(), this.getParameterBindingGroup(), null,
				"parameterBindingGroup", null, 0, 1, InteractionFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getInteractionFlow_SourceInteractionFlowElement(), this.getInteractionFlowElement(),
				this.getInteractionFlowElement_OutInteractionFlows(), "sourceInteractionFlowElement", null, 1, 1,
				InteractionFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getInteractionFlow_TargetInteractionFlowElement(), this.getInteractionFlowElement(),
				this.getInteractionFlowElement_InInteractionFlows(), "targetInteractionFlowElement", null, 1, 1,
				InteractionFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(interactionFlowExpressionEClass, InteractionFlowExpression.class, "InteractionFlowExpression",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getInteractionFlowExpression_InteractionFlow(), this.getInteractionFlow(), null,
				"interactionFlow", null, 2, -1, InteractionFlowExpression.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(systemEventEClass, SystemEvent.class, "SystemEvent", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSystemEvent_TriggeringExpressions(), this.getExpression(), null, "triggeringExpressions",
				null, 0, -1, SystemEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getSystemEvent_Type(), theDataTypesPackage.getSystemEventType(), "type", null, 1, 1,
				SystemEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, !IS_ORDERED);

		initEClass(parameterBindingEClass, ParameterBinding.class, "ParameterBinding", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getParameterBinding_SourceParameter(), this.getIFMLParameter(), null, "sourceParameter", null, 1,
				1, ParameterBinding.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getParameterBinding_TargetParameter(), this.getIFMLParameter(), null, "targetParameter", null, 1,
				1, ParameterBinding.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEClass(domainModelEClass, DomainModel.class, "DomainModel", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getDomainModel_DomainElements(), this.getDomainElement(), null, "domainElements", null, 0, -1,
		...
		initEClass(portDefinitionEClass, PortDefinition.class, "PortDefinition", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPortDefinition_Ports(), this.getIFMLPort(), this.getIFMLPort_PortDefinition(), "ports", null,
				0, -1, PortDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(contentBindingEClass, ContentBinding.class, "ContentBinding", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getContentBinding_UniformResourceIdentifier(), ecorePackage.getEString(),
				"uniformResourceIdentifier", null, 0, 1, ContentBinding.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(viewElementEClass, ViewElement.class, "ViewElement", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getViewElement_ViewElementEvents(), this.getViewElementEvent(), null, "viewElementEvents", null,
				0, -1, ViewElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getViewElement_ActivationExpression(), this.getActivationExpression(), null,
				"activationExpression", null, 0, 1, ViewElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getViewElement_ViewContainer(), this.getViewContainer(), this.getViewContainer_ViewElements(),
				"viewContainer", null, 0, 1, ViewElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(expressionEClass, Expression.class, "Expression", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getExpression_Language(), ecorePackage.getEString(), "language", null, 1, 1, Expression.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEAttribute(getExpression_Body(), ecorePackage.getEString(), "body", null, 1, 1, Expression.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);

		initEClass(dynamicBehaviorEClass, DynamicBehavior.class, "DynamicBehavior", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getDynamicBehavior_BehavioralFeatureConcept(), this.getBehavioralFeatureConcept(),
				this.getBehavioralFeatureConcept_DynamicBehavior(), "behavioralFeatureConcept", null, 0, 1,
				DynamicBehavior.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getDynamicBehavior_BehaviorConcept(), this.getBehaviorConcept(),
				this.getBehaviorConcept_DynamicBehavior(), "behaviorConcept", null, 0, 1, DynamicBehavior.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(viewpointEClass, Viewpoint.class, "Viewpoint", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getViewpoint_InteractionFlowModelElements(), this.getInteractionFlowModelElement(), null,
				"interactionFlowModelElements", null, 0, -1, Viewpoint.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getViewpoint_Context(), this.getContext(), null, "context", null, 1, 1, Viewpoint.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEClass(viewComponentPartEClass, ViewComponentPart.class, "ViewComponentPart", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getViewComponentPart_ViewElementEvents(), this.getViewElementEvent(), null, "viewElementEvents",
				null, 0, -1, ViewComponentPart.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getViewComponentPart_ActivationExpression(), this.getActivationExpression(), null,
				"activationExpression", null, 0, 1, ViewComponentPart.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getViewComponentPart_ParentViewComponentPart(), this.getViewComponentPart(),
				this.getViewComponentPart_SubViewComponentParts(), "parentViewComponentPart", null, 0, 1,
		...
		initEReference(getViewComponentPart_SubViewComponentParts(), this.getViewComponentPart(),
				this.getViewComponentPart_ParentViewComponentPart(), "subViewComponentParts", null, 0, -1,
				ViewComponentPart.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(viewContainerEClass, ViewContainer.class, "ViewContainer", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getViewContainer_IsLandmark(), ecorePackage.getEBoolean(), "isLandmark", null, 1, 1,
				ViewContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, !IS_ORDERED);
		initEAttribute(getViewContainer_IsDefault(), ecorePackage.getEBoolean(), "isDefault", null, 1, 1,
				ViewContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, !IS_ORDERED);
		initEAttribute(getViewContainer_IsXOR(), ecorePackage.getEBoolean(), "isXOR", null, 1, 1, ViewContainer.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEReference(getViewContainer_ViewElements(), this.getViewElement(), this.getViewElement_ViewContainer(),
				"viewElements", null, 0, -1, ViewContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getViewContainer_Actions(), this.getIFMLAction(), this.getIFMLAction_ViewContainer(), "actions",
				null, 0, -1, ViewContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(activationExpressionEClass, ActivationExpression.class, "ActivationExpression", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(interactionFlowModelEClass, InteractionFlowModel.class, "InteractionFlowModel", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getInteractionFlowModel_InteractionFlowModelElements(), this.getInteractionFlowModelElement(),
				null, "interactionFlowModelElements", null, 0, -1, InteractionFlowModel.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEReference(getInteractionFlowModel_ScreenZoom(), this.getScreenZoom(), null, "screenZoom", null, 0, 1,
				InteractionFlowModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getInteractionFlowModel_ChangeBackgroundColor(), this.getLightBackgroundColor(), null,
				"changeBackgroundColor", null, 0, 1, InteractionFlowModel.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getInteractionFlowModel_NavBarContainer(), this.getViewContainer(), null, "navBarContainer",
				null, 0, -1, InteractionFlowModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getInteractionFlowModel_SetLanguage(), this.getLanguage(), null, "setLanguage", null, 0, 1,
				InteractionFlowModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(contextDimensionEClass, ContextDimension.class, "ContextDimension", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(essentialIFMLModelEClass, EssentialIFMLModel.class, "EssentialIFMLModel", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getEssentialIFMLModel_InteractionFlowModel(), this.getInteractionFlowModel(), null,
				"interactionFlowModel", null, 1, 1, EssentialIFMLModel.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getEssentialIFMLModel_DomainModel(), this.getDomainModel(), null, "domainModel", null, 1, 1,
				EssentialIFMLModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getEssentialIFMLModel_InteractionFlowModelViewpoint(), this.getViewpoint(), null,
				"interactionFlowModelViewpoint", null, 0, -1, EssentialIFMLModel.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(moduleDefinitionEClass, ModuleDefinition.class, "ModuleDefinition", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getModuleDefinition_InputPorts(), this.getPortDefinition(), null, "inputPorts", null, 0, -1,
				ModuleDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getModuleDefinition_OutputPorts(), this.getPortDefinition(), null, "outputPorts", null, 0, -1,
				ModuleDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getModuleDefinition_InteractionFlowModelElement(), this.getInteractionFlowModelElement(), null,
				...
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getModuleDefinition_Modules(), this.getIFMLModule(), this.getIFMLModule_ModuleDefinition(),
				"modules", null, 0, -1, ModuleDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getModuleDefinition_ActivityConcept(), this.getActivityConcept(),
				this.getActivityConcept_ModuleDefinition(), "activityConcept", null, 0, 1, ModuleDefinition.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEClass(interactionFlowElementEClass, InteractionFlowElement.class, "InteractionFlowElement", IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getInteractionFlowElement_Parameters(), this.getIFMLParameter(), null, "parameters", null, 0, -1,
				InteractionFlowElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getInteractionFlowElement_OutInteractionFlows(), this.getInteractionFlow(),
				this.getInteractionFlow_SourceInteractionFlowElement(), "outInteractionFlows", null, 0, -1,
				InteractionFlowElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getInteractionFlowElement_InInteractionFlows(), this.getInteractionFlow(),
				this.getInteractionFlow_TargetInteractionFlowElement(), "inInteractionFlows", null, 0, -1,
				InteractionFlowElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(ifmlActionEClass, IFMLAction.class, "IFMLAction", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getIFMLAction_ActionEvents(), this.getActionEvent(), null, "actionEvents", null, 0, -1,
				IFMLAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getIFMLAction_DynamicBehavior(), this.getDynamicBehavior(), null, "dynamicBehavior", null, 0, 1,
				IFMLAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getIFMLAction_ViewContainer(), this.getViewContainer(), this.getViewContainer_Actions(),
				"viewContainer", null, 0, 1, IFMLAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getElement_Constraints(), this.getConstraint(), null, "constraints", null, 0, -1, Element.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getElement_Annotations(), this.getAnnotation(), null, "annotations", null, 0, -1, Element.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEClass(viewComponentEClass, ViewComponent.class, "ViewComponent", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getViewComponent_ViewComponentParts(), this.getViewComponentPart(), null, "viewComponentParts",
				null, 0, -1, ViewComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(ifmlParameterEClass, IFMLParameter.class, "IFMLParameter", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getIFMLParameter_Direction(), theDataTypesPackage.getDirection(), "direction", "in", 1, 1,
				IFMLParameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, !IS_ORDERED);
		initEReference(getIFMLParameter_DefaultValue(), this.getExpression(), null, "defaultValue", null, 0, 1,
				IFMLParameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getIFMLParameter_Type(), theUMLPackage.getType(), null, "type", null, 0, 1, IFMLParameter.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(dataBindingEClass, DataBinding.class, "DataBinding", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getDataBinding_ConditionalExpression(), this.getConditionalExpression(), null,
				"conditionalExpression", null, 0, -1, DataBinding.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getDataBinding_VisualizationAttribute(), this.getVisualizationAttribute(), null,
				"visualizationAttribute", null, 0, -1, DataBinding.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getDataBinding_DataContextVariables(), this.getDataContextVariable(),
				this.getDataContextVariable_DataBinding(), "dataContextVariables", null, 0, -1, DataBinding.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getDataBinding_DomainConcept(), this.getDomainConcept(), this.getDomainConcept_DataBinding(),
				"domainConcept", null, 0, 1, DataBinding.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getContext_ContextDimensions(), this.getContextDimension(), null, "contextDimensions", null, 0,
				-1, Context.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getContext_ContextVariables(), this.getContextVariable(), this.getContextVariable_Context(),
				"contextVariables", null, 0, -1, Context.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(visualizationAttributeEClass, VisualizationAttribute.class, "VisualizationAttribute", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getVisualizationAttribute_FeatureConcept(), this.getFeatureConcept(), null, "featureConcept",
				null, 1, 1, VisualizationAttribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(eventEClass, Event.class, "Event", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getEvent_ActivationExpression(), this.getActivationExpression(), null, "activationExpression",
				null, 0, 1, Event.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getEvent_InteractionFlowExpression(), this.getInteractionFlowExpression(), null,
				"interactionFlowExpression", null, 0, 1, Event.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEClass(annotationEClass, Annotation.class, "Annotation", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getAnnotation_Text(), ecorePackage.getEString(), "text", null, 1, 1, Annotation.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);

		initEClass(modulePackageEClass, ModulePackage.class, "ModulePackage", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getModulePackage_ModularizationElements(), this.getModularizationElement(),
				this.getModularizationElement_ModulePackage(), "modularizationElements", null, 0, -1,
				ModulePackage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(modularizationElementEClass, ModularizationElement.class, "ModularizationElement", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getModularizationElement_ModulePackage(), this.getModulePackage(),
				this.getModulePackage_ModularizationElements(), "modulePackage", null, 0, 1,
				ModularizationElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(ifmlModuleEClass, IFMLModule.class, "IFMLModule", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getIFMLModule_ModuleDefinition(), this.getModuleDefinition(), this.getModuleDefinition_Modules(),
				"moduleDefinition", null, 1, 1, IFMLModule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getIFMLModule_Ports(), this.getIFMLPort(), this.getIFMLPort_Module(), "ports", null, 0, -1,
				IFMLModule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(ifmlPortEClass, IFMLPort.class, "IFMLPort", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getIFMLPort_PortDefinition(), this.getPortDefinition(), this.getPortDefinition_Ports(),
				"portDefinition", null, 1, 1, IFMLPort.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getIFMLPort_Module(), this.getIFMLModule(), this.getIFMLModule_Ports(), "module", null, 1, 1,
				IFMLPort.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEClass(bpmnActivityConceptEClass, BPMNActivityConcept.class, "BPMNActivityConcept", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(contextVariableEClass, ContextVariable.class, "ContextVariable", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getContextVariable_Context(), this.getContext(), this.getContext_ContextVariables(), "context",
				null, 1, 1, ContextVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getContextVariable_Scope(), theDataTypesPackage.getContextVariableScope(), "scope", null, 1, 1,
				ContextVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, !IS_ORDERED);

		initEClass(simpleContextVariableEClass, SimpleContextVariable.class, "SimpleContextVariable", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(dataContextVariableEClass, DataContextVariable.class, "DataContextVariable", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getDataContextVariable_DataBinding(), this.getDataBinding(),
				this.getDataBinding_DataContextVariables(), "dataBinding", null, 1, 1, DataContextVariable.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(domainConceptEClass, DomainConcept.class, "DomainConcept", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getDomainConcept_DataBinding(), this.getDataBinding(), this.getDataBinding_DomainConcept(),
				"dataBinding", null, 0, 1, DomainConcept.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(featureConceptEClass, FeatureConcept.class, "FeatureConcept", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getFeatureConcept_VisualizationAttribute(), this.getVisualizationAttribute(), null,
				"visualizationAttribute", null, 0, 1, FeatureConcept.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(behaviorConceptEClass, BehaviorConcept.class, "BehaviorConcept", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getBehaviorConcept_DynamicBehavior(), this.getDynamicBehavior(),
				this.getDynamicBehavior_BehaviorConcept(), "dynamicBehavior", null, 0, 1, BehaviorConcept.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(behavioralFeatureConceptEClass, BehavioralFeatureConcept.class, "BehavioralFeatureConcept",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getBehavioralFeatureConcept_DynamicBehavior(), this.getDynamicBehavior(),
				this.getDynamicBehavior_BehavioralFeatureConcept(), "dynamicBehavior", null, 1, 1,
				BehavioralFeatureConcept.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(umlBehaviorEClass, UMLBehavior.class, "UMLBehavior", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getUMLBehavior_Behavior(), theUMLPackage.getBehavior(), null, "behavior", null, 0, 1,
				UMLBehavior.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(umlBehavioralFeatureEClass, UMLBehavioralFeature.class, "UMLBehavioralFeature", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getUMLBehavioralFeature_BehavioralFeature(), theUMLPackage.getBehavioralFeature(), null,
				"behavioralFeature", null, 0, 1, UMLBehavioralFeature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(umlDomainConceptEClass, UMLDomainConcept.class, "UMLDomainConcept", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getUMLDomainConcept_Classifier(), theUMLPackage.getClassifier(), null, "classifier", null, 0, 1,
				UMLDomainConcept.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(umlStructuralFeatureEClass, UMLStructuralFeature.class, "UMLStructuralFeature", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getUMLStructuralFeature_StructuralFeature(), theUMLPackage.getStructuralFeature(), null,
				"structuralFeature", null, 0, 1, UMLStructuralFeature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(activityConceptEClass, ActivityConcept.class, "ActivityConcept", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getActivityConcept_ModuleDefinition(), this.getModuleDefinition(),
				this.getModuleDefinition_ActivityConcept(), "moduleDefinition", null, 1, 1, ActivityConcept.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(domainElementEClass, DomainElement.class, "DomainElement", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(screenZoomEClass, ScreenZoom.class, "ScreenZoom", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(lightBackgroundColorEClass, LightBackgroundColor.class, "LightBackgroundColor", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
