 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.UMLBehaviorImpl#getBehavior <em>Behavior</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UMLBehaviorImpl extends BehaviorConceptImpl implements UMLBehavior {
		...
		if (behavior != null && behavior.eIsProxy()) {
			...
			if (behavior != oldBehavior) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CorePackage.UML_BEHAVIOR__BEHAVIOR,
	...
	public void setBehavior(Behavior newBehavior) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.UML_BEHAVIOR__BEHAVIOR, oldBehavior,
					behavior));
	}
