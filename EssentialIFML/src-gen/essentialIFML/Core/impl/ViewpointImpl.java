 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.ViewpointImpl#getInteractionFlowModelElements <em>Interaction Flow Model Elements</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.ViewpointImpl#getContext <em>Context</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ViewpointImpl extends NamedElementImpl implements Viewpoint {
	...
	public EList<InteractionFlowModelElement> getInteractionFlowModelElements() {
		if (interactionFlowModelElements == null) {
			interactionFlowModelElements = new EObjectResolvingEList<InteractionFlowModelElement>(
					InteractionFlowModelElement.class, this, CorePackage.VIEWPOINT__INTERACTION_FLOW_MODEL_ELEMENTS);
		}
		...
		if (context != null && context.eIsProxy()) {
			...
			if (context != oldContext) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CorePackage.VIEWPOINT__CONTEXT,
							oldContext, context));
			}
		}
		return context;
