 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.DomainModelImpl#getDomainElements <em>Domain Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DomainModelImpl extends NamedElementImpl implements DomainModel {
	...
	public EList<DomainElement> getDomainElements() {
		if (domainElements == null) {
			domainElements = new EObjectContainmentEList<DomainElement>(DomainElement.class, this,
					CorePackage.DOMAIN_MODEL__DOMAIN_ELEMENTS);
		}
