 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.ModuleDefinitionImpl#getInputPorts <em>Input Ports</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.ModuleDefinitionImpl#getOutputPorts <em>Output Ports</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.ModuleDefinitionImpl#getInteractionFlowModelElement <em>Interaction Flow Model Element</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.ModuleDefinitionImpl#getModules <em>Modules</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.ModuleDefinitionImpl#getActivityConcept <em>Activity Concept</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModuleDefinitionImpl extends ModularizationElementImpl implements ModuleDefinition {
	...
	public EList<PortDefinition> getInputPorts() {
		if (inputPorts == null) {
			inputPorts = new EObjectContainmentEList<PortDefinition>(PortDefinition.class, this,
					CorePackage.MODULE_DEFINITION__INPUT_PORTS);
		}
		return inputPorts;
	}
	...
	public EList<PortDefinition> getOutputPorts() {
		if (outputPorts == null) {
			outputPorts = new EObjectContainmentEList<PortDefinition>(PortDefinition.class, this,
					CorePackage.MODULE_DEFINITION__OUTPUT_PORTS);
		}
		return outputPorts;
	}
	...
	public EList<InteractionFlowModelElement> getInteractionFlowModelElement() {
		if (interactionFlowModelElement == null) {
			interactionFlowModelElement = new EObjectContainmentEList<InteractionFlowModelElement>(
					...
					CorePackage.MODULE_DEFINITION__INTERACTION_FLOW_MODEL_ELEMENT);
		}
	...
	public EList<IFMLModule> getModules() {
		if (modules == null) {
			modules = new EObjectWithInverseResolvingEList<IFMLModule>(IFMLModule.class, this,
					CorePackage.MODULE_DEFINITION__MODULES, CorePackage.IFML_MODULE__MODULE_DEFINITION);
		}
		return modules;
	}
			...
			if (activityConcept != oldActivityConcept) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CorePackage.MODULE_DEFINITION__ACTIVITY_CONCEPT, oldActivityConcept, activityConcept));
			}
		}
	...
	public NotificationChain basicSetActivityConcept(ActivityConcept newActivityConcept, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CorePackage.MODULE_DEFINITION__ACTIVITY_CONCEPT, oldActivityConcept, newActivityConcept);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setActivityConcept(ActivityConcept newActivityConcept) {
		if (newActivityConcept != activityConcept) {
			...
			if (activityConcept != null)
				msgs = ((InternalEObject) activityConcept).eInverseRemove(this,
						CorePackage.ACTIVITY_CONCEPT__MODULE_DEFINITION, ActivityConcept.class, msgs);
			if (newActivityConcept != null)
				msgs = ((InternalEObject) newActivityConcept).eInverseAdd(this,
						CorePackage.ACTIVITY_CONCEPT__MODULE_DEFINITION, ActivityConcept.class, msgs);
			msgs = basicSetActivityConcept(newActivityConcept, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.MODULE_DEFINITION__ACTIVITY_CONCEPT,
					newActivityConcept, newActivityConcept));
	}
