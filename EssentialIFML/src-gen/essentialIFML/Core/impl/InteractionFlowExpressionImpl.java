 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.InteractionFlowExpressionImpl#getInteractionFlow <em>Interaction Flow</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InteractionFlowExpressionImpl extends ExpressionImpl implements InteractionFlowExpression {
	...
	public EList<InteractionFlow> getInteractionFlow() {
		if (interactionFlow == null) {
			interactionFlow = new EObjectResolvingEList<InteractionFlow>(InteractionFlow.class, this,
					CorePackage.INTERACTION_FLOW_EXPRESSION__INTERACTION_FLOW);
		}
