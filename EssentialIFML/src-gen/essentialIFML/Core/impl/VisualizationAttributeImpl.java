 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.VisualizationAttributeImpl#getFeatureConcept <em>Feature Concept</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VisualizationAttributeImpl extends ViewComponentPartImpl implements VisualizationAttribute {
			...
			if (featureConcept != oldFeatureConcept) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CorePackage.VISUALIZATION_ATTRIBUTE__FEATURE_CONCEPT, oldFeatureConcept, featureConcept));
			}
		}
	...
	public void setFeatureConcept(FeatureConcept newFeatureConcept) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.VISUALIZATION_ATTRIBUTE__FEATURE_CONCEPT,
					oldFeatureConcept, featureConcept));
	}
