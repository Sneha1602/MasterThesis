 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.DataBindingImpl#getConditionalExpression <em>Conditional Expression</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.DataBindingImpl#getVisualizationAttribute <em>Visualization Attribute</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.DataBindingImpl#getDataContextVariables <em>Data Context Variables</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.DataBindingImpl#getDomainConcept <em>Domain Concept</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataBindingImpl extends ContentBindingImpl implements DataBinding {
	...
	public EList<ConditionalExpression> getConditionalExpression() {
		if (conditionalExpression == null) {
			conditionalExpression = new EObjectContainmentEList<ConditionalExpression>(ConditionalExpression.class,
					this, CorePackage.DATA_BINDING__CONDITIONAL_EXPRESSION);
		}
	...
	public EList<VisualizationAttribute> getVisualizationAttribute() {
		if (visualizationAttribute == null) {
			visualizationAttribute = new EObjectContainmentEList<VisualizationAttribute>(VisualizationAttribute.class,
					this, CorePackage.DATA_BINDING__VISUALIZATION_ATTRIBUTE);
		}
	...
	public EList<DataContextVariable> getDataContextVariables() {
		if (dataContextVariables == null) {
			dataContextVariables = new EObjectWithInverseResolvingEList<DataContextVariable>(DataContextVariable.class,
					this, CorePackage.DATA_BINDING__DATA_CONTEXT_VARIABLES,
					CorePackage.DATA_CONTEXT_VARIABLE__DATA_BINDING);
		}
		...
		if (domainConcept != null && domainConcept.eIsProxy()) {
			...
			if (domainConcept != oldDomainConcept) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CorePackage.DATA_BINDING__DOMAIN_CONCEPT,
	...
	public NotificationChain basicSetDomainConcept(DomainConcept newDomainConcept, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CorePackage.DATA_BINDING__DOMAIN_CONCEPT, oldDomainConcept, newDomainConcept);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setDomainConcept(DomainConcept newDomainConcept) {
		if (newDomainConcept != domainConcept) {
			...
			if (domainConcept != null)
				msgs = ((InternalEObject) domainConcept).eInverseRemove(this, CorePackage.DOMAIN_CONCEPT__DATA_BINDING,
						DomainConcept.class, msgs);
			if (newDomainConcept != null)
				msgs = ((InternalEObject) newDomainConcept).eInverseAdd(this, CorePackage.DOMAIN_CONCEPT__DATA_BINDING,
						DomainConcept.class, msgs);
			msgs = basicSetDomainConcept(newDomainConcept, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.DATA_BINDING__DOMAIN_CONCEPT,
					newDomainConcept, newDomainConcept));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case CorePackage.DATA_BINDING__DATA_CONTEXT_VARIABLES:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getDataContextVariables()).basicAdd(otherEnd,
					msgs);
