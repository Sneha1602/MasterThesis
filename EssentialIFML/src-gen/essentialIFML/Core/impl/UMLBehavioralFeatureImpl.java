 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.UMLBehavioralFeatureImpl#getBehavioralFeature <em>Behavioral Feature</em>}</li>
 * </ul>
 *
 * @generated
 */
			...
			if (behavioralFeature != oldBehavioralFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CorePackage.UML_BEHAVIORAL_FEATURE__BEHAVIORAL_FEATURE, oldBehavioralFeature,
							behavioralFeature));
			}
		}
	...
	public void setBehavioralFeature(BehavioralFeature newBehavioralFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.UML_BEHAVIORAL_FEATURE__BEHAVIORAL_FEATURE, oldBehavioralFeature, behavioralFeature));
	}
