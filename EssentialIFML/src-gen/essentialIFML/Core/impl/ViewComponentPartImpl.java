 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.ViewComponentPartImpl#getViewElementEvents <em>View Element Events</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.ViewComponentPartImpl#getActivationExpression <em>Activation Expression</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.ViewComponentPartImpl#getParentViewComponentPart <em>Parent View Component Part</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.ViewComponentPartImpl#getSubViewComponentParts <em>Sub View Component Parts</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ViewComponentPartImpl extends InteractionFlowElementImpl implements ViewComponentPart {
	...
	public EList<ViewElementEvent> getViewElementEvents() {
		if (viewElementEvents == null) {
			viewElementEvents = new EObjectContainmentEList<ViewElementEvent>(ViewElementEvent.class, this,
					CorePackage.VIEW_COMPONENT_PART__VIEW_ELEMENT_EVENTS);
		}
			...
			if (activationExpression != oldActivationExpression) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CorePackage.VIEW_COMPONENT_PART__ACTIVATION_EXPRESSION, oldActivationExpression,
	...
	public ViewComponentPart getParentViewComponentPart() {
		if (eContainerFeatureID() != CorePackage.VIEW_COMPONENT_PART__PARENT_VIEW_COMPONENT_PART)
			return null;
	...
	public NotificationChain basicSetParentViewComponentPart(ViewComponentPart newParentViewComponentPart,
		...
		msgs = eBasicSetContainer((InternalEObject) newParentViewComponentPart,
				CorePackage.VIEW_COMPONENT_PART__PARENT_VIEW_COMPONENT_PART, msgs);
		return msgs;
	}
	...
	public void setParentViewComponentPart(ViewComponentPart newParentViewComponentPart) {
		if (newParentViewComponentPart != eInternalContainer()
				|| (eContainerFeatureID() != CorePackage.VIEW_COMPONENT_PART__PARENT_VIEW_COMPONENT_PART
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.VIEW_COMPONENT_PART__PARENT_VIEW_COMPONENT_PART, newParentViewComponentPart,
	...
	public EList<ViewComponentPart> getSubViewComponentParts() {
		if (subViewComponentParts == null) {
			subViewComponentParts = new EObjectContainmentWithInverseEList<ViewComponentPart>(ViewComponentPart.class,
					this, CorePackage.VIEW_COMPONENT_PART__SUB_VIEW_COMPONENT_PARTS,
