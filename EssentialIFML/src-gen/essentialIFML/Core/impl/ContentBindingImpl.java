 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.ContentBindingImpl#getUniformResourceIdentifier <em>Uniform Resource Identifier</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ContentBindingImpl extends ViewComponentPartImpl implements ContentBinding {
	...
	public void setUniformResourceIdentifier(String newUniformResourceIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.CONTENT_BINDING__UNIFORM_RESOURCE_IDENTIFIER, oldUniformResourceIdentifier,
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case CorePackage.CONTENT_BINDING__UNIFORM_RESOURCE_IDENTIFIER:
			return UNIFORM_RESOURCE_IDENTIFIER_EDEFAULT == null ? uniformResourceIdentifier != null
					: !UNIFORM_RESOURCE_IDENTIFIER_EDEFAULT.equals(uniformResourceIdentifier);
		}
