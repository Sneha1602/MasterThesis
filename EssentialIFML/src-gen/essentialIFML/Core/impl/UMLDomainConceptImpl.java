 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.UMLDomainConceptImpl#getClassifier <em>Classifier</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UMLDomainConceptImpl extends DomainConceptImpl implements UMLDomainConcept {
			...
			if (classifier != oldClassifier) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CorePackage.UML_DOMAIN_CONCEPT__CLASSIFIER, oldClassifier, classifier));
			}
		}
		return classifier;
	}
	...
	public void setClassifier(Classifier newClassifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.UML_DOMAIN_CONCEPT__CLASSIFIER,
