 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.ConditionalExpressionImpl#getName <em>Name</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.ConditionalExpressionImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.ConditionalExpressionImpl#getOutInteractionFlows <em>Out Interaction Flows</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.ConditionalExpressionImpl#getInInteractionFlows <em>In Interaction Flows</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.ConditionalExpressionImpl#getViewElementEvents <em>View Element Events</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.ConditionalExpressionImpl#getActivationExpression <em>Activation Expression</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.ConditionalExpressionImpl#getParentViewComponentPart <em>Parent View Component Part</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.ConditionalExpressionImpl#getSubViewComponentParts <em>Sub View Component Parts</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConditionalExpressionImpl extends ExpressionImpl implements ConditionalExpression {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.CONDITIONAL_EXPRESSION__NAME, oldName,
					name));
	}
	...
	public EList<IFMLParameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<IFMLParameter>(IFMLParameter.class, this,
					CorePackage.CONDITIONAL_EXPRESSION__PARAMETERS);
		}
		return parameters;
	}
	...
	public EList<InteractionFlow> getOutInteractionFlows() {
		if (outInteractionFlows == null) {
			outInteractionFlows = new EObjectContainmentWithInverseEList<InteractionFlow>(InteractionFlow.class, this,
					CorePackage.CONDITIONAL_EXPRESSION__OUT_INTERACTION_FLOWS,
					CorePackage.INTERACTION_FLOW__SOURCE_INTERACTION_FLOW_ELEMENT);
		}
	...
	public EList<InteractionFlow> getInInteractionFlows() {
		if (inInteractionFlows == null) {
			inInteractionFlows = new EObjectWithInverseResolvingEList<InteractionFlow>(InteractionFlow.class, this,
					CorePackage.CONDITIONAL_EXPRESSION__IN_INTERACTION_FLOWS,
					CorePackage.INTERACTION_FLOW__TARGET_INTERACTION_FLOW_ELEMENT);
		}
	...
	public EList<ViewElementEvent> getViewElementEvents() {
		if (viewElementEvents == null) {
			viewElementEvents = new EObjectContainmentEList<ViewElementEvent>(ViewElementEvent.class, this,
					CorePackage.CONDITIONAL_EXPRESSION__VIEW_ELEMENT_EVENTS);
		}
			...
			if (activationExpression != oldActivationExpression) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CorePackage.CONDITIONAL_EXPRESSION__ACTIVATION_EXPRESSION, oldActivationExpression,
	...
	public ViewComponentPart getParentViewComponentPart() {
		if (eContainerFeatureID() != CorePackage.CONDITIONAL_EXPRESSION__PARENT_VIEW_COMPONENT_PART)
			return null;
	...
	public NotificationChain basicSetParentViewComponentPart(ViewComponentPart newParentViewComponentPart,
		...
		msgs = eBasicSetContainer((InternalEObject) newParentViewComponentPart,
				CorePackage.CONDITIONAL_EXPRESSION__PARENT_VIEW_COMPONENT_PART, msgs);
		return msgs;
	}
	...
	public void setParentViewComponentPart(ViewComponentPart newParentViewComponentPart) {
		if (newParentViewComponentPart != eInternalContainer()
				|| (eContainerFeatureID() != CorePackage.CONDITIONAL_EXPRESSION__PARENT_VIEW_COMPONENT_PART
			...
			if (newParentViewComponentPart != null)
				msgs = ((InternalEObject) newParentViewComponentPart).eInverseAdd(this,
						CorePackage.VIEW_COMPONENT_PART__SUB_VIEW_COMPONENT_PARTS, ViewComponentPart.class, msgs);
			msgs = basicSetParentViewComponentPart(newParentViewComponentPart, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.CONDITIONAL_EXPRESSION__PARENT_VIEW_COMPONENT_PART, newParentViewComponentPart,
	...
	public EList<ViewComponentPart> getSubViewComponentParts() {
		if (subViewComponentParts == null) {
			subViewComponentParts = new EObjectContainmentWithInverseEList<ViewComponentPart>(ViewComponentPart.class,
					this, CorePackage.CONDITIONAL_EXPRESSION__SUB_VIEW_COMPONENT_PARTS,
					CorePackage.VIEW_COMPONENT_PART__PARENT_VIEW_COMPONENT_PART);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case CorePackage.CONDITIONAL_EXPRESSION__IN_INTERACTION_FLOWS:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getInInteractionFlows()).basicAdd(otherEnd,
					msgs);
		...
		case CorePackage.CONDITIONAL_EXPRESSION__SUB_VIEW_COMPONENT_PARTS:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getSubViewComponentParts()).basicAdd(otherEnd,
					msgs);
		}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case CorePackage.CONDITIONAL_EXPRESSION__PARENT_VIEW_COMPONENT_PART:
			return eInternalContainer().eInverseRemove(this, CorePackage.VIEW_COMPONENT_PART__SUB_VIEW_COMPONENT_PARTS,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case CorePackage.CONDITIONAL_EXPRESSION__ACTIVATION_EXPRESSION:
			if (resolve)
				return getActivationExpression();
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == InteractionFlowElement.class) {
			switch (derivedFeatureID) {
			case CorePackage.CONDITIONAL_EXPRESSION__PARAMETERS:
				return CorePackage.INTERACTION_FLOW_ELEMENT__PARAMETERS;
			case CorePackage.CONDITIONAL_EXPRESSION__OUT_INTERACTION_FLOWS:
				return CorePackage.INTERACTION_FLOW_ELEMENT__OUT_INTERACTION_FLOWS;
			case CorePackage.CONDITIONAL_EXPRESSION__IN_INTERACTION_FLOWS:
				return CorePackage.INTERACTION_FLOW_ELEMENT__IN_INTERACTION_FLOWS;
			default:
				return -1;
			}
		}
		if (baseClass == ViewComponentPart.class) {
			switch (derivedFeatureID) {
			case CorePackage.CONDITIONAL_EXPRESSION__VIEW_ELEMENT_EVENTS:
				return CorePackage.VIEW_COMPONENT_PART__VIEW_ELEMENT_EVENTS;
			case CorePackage.CONDITIONAL_EXPRESSION__ACTIVATION_EXPRESSION:
				return CorePackage.VIEW_COMPONENT_PART__ACTIVATION_EXPRESSION;
			case CorePackage.CONDITIONAL_EXPRESSION__PARENT_VIEW_COMPONENT_PART:
				return CorePackage.VIEW_COMPONENT_PART__PARENT_VIEW_COMPONENT_PART;
			case CorePackage.CONDITIONAL_EXPRESSION__SUB_VIEW_COMPONENT_PARTS:
				return CorePackage.VIEW_COMPONENT_PART__SUB_VIEW_COMPONENT_PARTS;
			default:
				return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			...
			case CorePackage.NAMED_ELEMENT__NAME:
				return CorePackage.CONDITIONAL_EXPRESSION__NAME;
			default:
				return -1;
			}
		}
		if (baseClass == InteractionFlowElement.class) {
			...
			case CorePackage.INTERACTION_FLOW_ELEMENT__PARAMETERS:
				return CorePackage.CONDITIONAL_EXPRESSION__PARAMETERS;
			case CorePackage.INTERACTION_FLOW_ELEMENT__OUT_INTERACTION_FLOWS:
				return CorePackage.CONDITIONAL_EXPRESSION__OUT_INTERACTION_FLOWS;
			case CorePackage.INTERACTION_FLOW_ELEMENT__IN_INTERACTION_FLOWS:
				return CorePackage.CONDITIONAL_EXPRESSION__IN_INTERACTION_FLOWS;
			default:
				return -1;
			}
		}
		if (baseClass == ViewComponentPart.class) {
			...
			case CorePackage.VIEW_COMPONENT_PART__VIEW_ELEMENT_EVENTS:
				return CorePackage.CONDITIONAL_EXPRESSION__VIEW_ELEMENT_EVENTS;
			case CorePackage.VIEW_COMPONENT_PART__ACTIVATION_EXPRESSION:
				return CorePackage.CONDITIONAL_EXPRESSION__ACTIVATION_EXPRESSION;
			case CorePackage.VIEW_COMPONENT_PART__PARENT_VIEW_COMPONENT_PART:
				return CorePackage.CONDITIONAL_EXPRESSION__PARENT_VIEW_COMPONENT_PART;
			case CorePackage.VIEW_COMPONENT_PART__SUB_VIEW_COMPONENT_PARTS:
				return CorePackage.CONDITIONAL_EXPRESSION__SUB_VIEW_COMPONENT_PARTS;
			default:
				return -1;
			}
		}
