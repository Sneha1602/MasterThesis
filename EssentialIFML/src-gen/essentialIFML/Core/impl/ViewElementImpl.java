 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.ViewElementImpl#getViewElementEvents <em>View Element Events</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.ViewElementImpl#getActivationExpression <em>Activation Expression</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.ViewElementImpl#getViewContainer <em>View Container</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ViewElementImpl extends InteractionFlowElementImpl implements ViewElement {
	...
	public EList<ViewElementEvent> getViewElementEvents() {
		if (viewElementEvents == null) {
			viewElementEvents = new EObjectContainmentEList<ViewElementEvent>(ViewElementEvent.class, this,
					CorePackage.VIEW_ELEMENT__VIEW_ELEMENT_EVENTS);
		}
			...
			if (activationExpression != oldActivationExpression) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CorePackage.VIEW_ELEMENT__ACTIVATION_EXPRESSION, oldActivationExpression,
	...
	public void setActivationExpression(ActivationExpression newActivationExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.VIEW_ELEMENT__ACTIVATION_EXPRESSION,
	...
	public ViewContainer getViewContainer() {
		if (eContainerFeatureID() != CorePackage.VIEW_ELEMENT__VIEW_CONTAINER)
			return null;
	...
	public void setViewContainer(ViewContainer newViewContainer) {
		if (newViewContainer != eInternalContainer()
				|| (eContainerFeatureID() != CorePackage.VIEW_ELEMENT__VIEW_CONTAINER && newViewContainer != null)) {
			...
			if (newViewContainer != null)
				msgs = ((InternalEObject) newViewContainer).eInverseAdd(this, CorePackage.VIEW_CONTAINER__VIEW_ELEMENTS,
						ViewContainer.class, msgs);
			msgs = basicSetViewContainer(newViewContainer, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.VIEW_ELEMENT__VIEW_CONTAINER,
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case CorePackage.VIEW_ELEMENT__VIEW_CONTAINER:
			return eInternalContainer().eInverseRemove(this, CorePackage.VIEW_CONTAINER__VIEW_ELEMENTS,
					ViewContainer.class, msgs);
		}
