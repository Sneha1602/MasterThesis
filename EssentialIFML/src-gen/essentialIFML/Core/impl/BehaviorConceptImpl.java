 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.BehaviorConceptImpl#getDynamicBehavior <em>Dynamic Behavior</em>}</li>
 * </ul>
 *
 * @generated
 */
			...
			if (dynamicBehavior != oldDynamicBehavior) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CorePackage.BEHAVIOR_CONCEPT__DYNAMIC_BEHAVIOR, oldDynamicBehavior, dynamicBehavior));
			}
		}
	...
	public NotificationChain basicSetDynamicBehavior(DynamicBehavior newDynamicBehavior, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CorePackage.BEHAVIOR_CONCEPT__DYNAMIC_BEHAVIOR, oldDynamicBehavior, newDynamicBehavior);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setDynamicBehavior(DynamicBehavior newDynamicBehavior) {
		if (newDynamicBehavior != dynamicBehavior) {
			...
			if (dynamicBehavior != null)
				msgs = ((InternalEObject) dynamicBehavior).eInverseRemove(this,
						CorePackage.DYNAMIC_BEHAVIOR__BEHAVIOR_CONCEPT, DynamicBehavior.class, msgs);
			if (newDynamicBehavior != null)
				msgs = ((InternalEObject) newDynamicBehavior).eInverseAdd(this,
						CorePackage.DYNAMIC_BEHAVIOR__BEHAVIOR_CONCEPT, DynamicBehavior.class, msgs);
			msgs = basicSetDynamicBehavior(newDynamicBehavior, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.BEHAVIOR_CONCEPT__DYNAMIC_BEHAVIOR,
					newDynamicBehavior, newDynamicBehavior));
	}
