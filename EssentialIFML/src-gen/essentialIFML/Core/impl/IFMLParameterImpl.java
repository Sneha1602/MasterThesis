 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.IFMLParameterImpl#getName <em>Name</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.IFMLParameterImpl#getDirection <em>Direction</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.IFMLParameterImpl#getDefaultValue <em>Default Value</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.IFMLParameterImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IFMLParameterImpl extends InteractionFlowModelElementImpl implements IFMLParameter {
	...
	public void setDirection(Direction newDirection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.IFML_PARAMETER__DIRECTION, oldDirection,
					direction));
	}
	...
	public Expression getDefaultValue() {
		if (defaultValue != null && defaultValue.eIsProxy()) {
			...
			if (defaultValue != oldDefaultValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CorePackage.IFML_PARAMETER__DEFAULT_VALUE,
	...
	public void setDefaultValue(Expression newDefaultValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.IFML_PARAMETER__DEFAULT_VALUE,
					oldDefaultValue, defaultValue));
	}
	...
	public Type getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CorePackage.IFML_PARAMETER__TYPE, oldType,
							type));
			}
		}
		return type;
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			...
			case CorePackage.NAMED_ELEMENT__NAME:
				return CorePackage.IFML_PARAMETER__NAME;
			default:
				return -1;
			}
		}
