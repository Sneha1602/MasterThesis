 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.ActivityConceptImpl#getModuleDefinition <em>Module Definition</em>}</li>
 * </ul>
 *
 * @generated
 */
			...
			if (moduleDefinition != oldModuleDefinition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CorePackage.ACTIVITY_CONCEPT__MODULE_DEFINITION, oldModuleDefinition, moduleDefinition));
			}
		}
	...
	public NotificationChain basicSetModuleDefinition(ModuleDefinition newModuleDefinition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CorePackage.ACTIVITY_CONCEPT__MODULE_DEFINITION, oldModuleDefinition, newModuleDefinition);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setModuleDefinition(ModuleDefinition newModuleDefinition) {
		if (newModuleDefinition != moduleDefinition) {
			...
			if (moduleDefinition != null)
				msgs = ((InternalEObject) moduleDefinition).eInverseRemove(this,
						CorePackage.MODULE_DEFINITION__ACTIVITY_CONCEPT, ModuleDefinition.class, msgs);
			if (newModuleDefinition != null)
				msgs = ((InternalEObject) newModuleDefinition).eInverseAdd(this,
						CorePackage.MODULE_DEFINITION__ACTIVITY_CONCEPT, ModuleDefinition.class, msgs);
			msgs = basicSetModuleDefinition(newModuleDefinition, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.ACTIVITY_CONCEPT__MODULE_DEFINITION,
