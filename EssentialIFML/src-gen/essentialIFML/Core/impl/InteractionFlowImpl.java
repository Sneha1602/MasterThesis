 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.InteractionFlowImpl#getParameterBindingGroup <em>Parameter Binding Group</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.InteractionFlowImpl#getSourceInteractionFlowElement <em>Source Interaction Flow Element</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.InteractionFlowImpl#getTargetInteractionFlowElement <em>Target Interaction Flow Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class InteractionFlowImpl extends InteractionFlowModelElementImpl implements InteractionFlow {
	...
	public NotificationChain basicSetParameterBindingGroup(ParameterBindingGroup newParameterBindingGroup,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CorePackage.INTERACTION_FLOW__PARAMETER_BINDING_GROUP, oldParameterBindingGroup,
		...
		if (newParameterBindingGroup != parameterBindingGroup) {
			...
			if (parameterBindingGroup != null)
				msgs = ((InternalEObject) parameterBindingGroup).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CorePackage.INTERACTION_FLOW__PARAMETER_BINDING_GROUP, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.INTERACTION_FLOW__PARAMETER_BINDING_GROUP,
					newParameterBindingGroup, newParameterBindingGroup));
	}
	...
	public InteractionFlowElement getSourceInteractionFlowElement() {
		if (eContainerFeatureID() != CorePackage.INTERACTION_FLOW__SOURCE_INTERACTION_FLOW_ELEMENT)
			return null;
	...
	public NotificationChain basicSetSourceInteractionFlowElement(
		...
		msgs = eBasicSetContainer((InternalEObject) newSourceInteractionFlowElement,
				CorePackage.INTERACTION_FLOW__SOURCE_INTERACTION_FLOW_ELEMENT, msgs);
		return msgs;
	}
	...
	public void setSourceInteractionFlowElement(InteractionFlowElement newSourceInteractionFlowElement) {
		if (newSourceInteractionFlowElement != eInternalContainer()
				|| (eContainerFeatureID() != CorePackage.INTERACTION_FLOW__SOURCE_INTERACTION_FLOW_ELEMENT
			...
			if (newSourceInteractionFlowElement != null)
				msgs = ((InternalEObject) newSourceInteractionFlowElement).eInverseAdd(this,
						CorePackage.INTERACTION_FLOW_ELEMENT__OUT_INTERACTION_FLOWS, InteractionFlowElement.class,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.INTERACTION_FLOW__SOURCE_INTERACTION_FLOW_ELEMENT, newSourceInteractionFlowElement,
					newSourceInteractionFlowElement));
	}
	...
	public NotificationChain basicSetTargetInteractionFlowElement(
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CorePackage.INTERACTION_FLOW__TARGET_INTERACTION_FLOW_ELEMENT, oldTargetInteractionFlowElement,
					newTargetInteractionFlowElement);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newTargetInteractionFlowElement != targetInteractionFlowElement) {
			...
			if (targetInteractionFlowElement != null)
				msgs = ((InternalEObject) targetInteractionFlowElement).eInverseRemove(this,
						CorePackage.INTERACTION_FLOW_ELEMENT__IN_INTERACTION_FLOWS, InteractionFlowElement.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.INTERACTION_FLOW__TARGET_INTERACTION_FLOW_ELEMENT, newTargetInteractionFlowElement,
					newTargetInteractionFlowElement));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case CorePackage.INTERACTION_FLOW__SOURCE_INTERACTION_FLOW_ELEMENT:
			return eInternalContainer().eInverseRemove(this,
					CorePackage.INTERACTION_FLOW_ELEMENT__OUT_INTERACTION_FLOWS, InteractionFlowElement.class, msgs);
		}
