 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.IFMLActionImpl#getActionEvents <em>Action Events</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.IFMLActionImpl#getDynamicBehavior <em>Dynamic Behavior</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.IFMLActionImpl#getViewContainer <em>View Container</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IFMLActionImpl extends InteractionFlowElementImpl implements IFMLAction {
	...
	public EList<ActionEvent> getActionEvents() {
		if (actionEvents == null) {
			actionEvents = new EObjectContainmentEList<ActionEvent>(ActionEvent.class, this,
					CorePackage.IFML_ACTION__ACTION_EVENTS);
		}
		return actionEvents;
	}
		...
		if (dynamicBehavior != null && dynamicBehavior.eIsProxy()) {
			...
			if (dynamicBehavior != oldDynamicBehavior) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CorePackage.IFML_ACTION__DYNAMIC_BEHAVIOR,
							oldDynamicBehavior, dynamicBehavior));
			}
		}
	...
	public void setDynamicBehavior(DynamicBehavior newDynamicBehavior) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.IFML_ACTION__DYNAMIC_BEHAVIOR,
					oldDynamicBehavior, dynamicBehavior));
	}
	...
	public ViewContainer getViewContainer() {
		if (eContainerFeatureID() != CorePackage.IFML_ACTION__VIEW_CONTAINER)
			return null;
	...
	public void setViewContainer(ViewContainer newViewContainer) {
		if (newViewContainer != eInternalContainer()
				|| (eContainerFeatureID() != CorePackage.IFML_ACTION__VIEW_CONTAINER && newViewContainer != null)) {
			...
			if (newViewContainer != null)
				msgs = ((InternalEObject) newViewContainer).eInverseAdd(this, CorePackage.VIEW_CONTAINER__ACTIONS,
						ViewContainer.class, msgs);
			msgs = basicSetViewContainer(newViewContainer, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.IFML_ACTION__VIEW_CONTAINER,
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case CorePackage.IFML_ACTION__VIEW_CONTAINER:
			return eInternalContainer().eInverseRemove(this, CorePackage.VIEW_CONTAINER__ACTIONS, ViewContainer.class,
					msgs);
		}
