 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.ContextVariableImpl#getContext <em>Context</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.ContextVariableImpl#getScope <em>Scope</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContextVariableImpl extends NamedElementImpl implements ContextVariable {
	...
	public Context getContext() {
		if (eContainerFeatureID() != CorePackage.CONTEXT_VARIABLE__CONTEXT)
			return null;
	...
	public void setContext(Context newContext) {
		if (newContext != eInternalContainer()
				|| (eContainerFeatureID() != CorePackage.CONTEXT_VARIABLE__CONTEXT && newContext != null)) {
			...
			if (newContext != null)
				msgs = ((InternalEObject) newContext).eInverseAdd(this, CorePackage.CONTEXT__CONTEXT_VARIABLES,
						Context.class, msgs);
			msgs = basicSetContext(newContext, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.CONTEXT_VARIABLE__CONTEXT, newContext,
					newContext));
	}
	...
	public void setScope(ContextVariableScope newScope) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.CONTEXT_VARIABLE__SCOPE, oldScope,
					scope));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case CorePackage.CONTEXT_VARIABLE__CONTEXT:
			return eInternalContainer().eInverseRemove(this, CorePackage.CONTEXT__CONTEXT_VARIABLES, Context.class,
					msgs);
		}
