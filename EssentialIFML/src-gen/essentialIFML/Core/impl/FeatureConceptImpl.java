 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.FeatureConceptImpl#getVisualizationAttribute <em>Visualization Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FeatureConceptImpl extends DomainElementImpl implements FeatureConcept {
			...
			if (visualizationAttribute != oldVisualizationAttribute) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CorePackage.FEATURE_CONCEPT__VISUALIZATION_ATTRIBUTE, oldVisualizationAttribute,
	...
	public void setVisualizationAttribute(VisualizationAttribute newVisualizationAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.FEATURE_CONCEPT__VISUALIZATION_ATTRIBUTE,
					oldVisualizationAttribute, visualizationAttribute));
	}
