 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.ParameterBindingImpl#getSourceParameter <em>Source Parameter</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.ParameterBindingImpl#getTargetParameter <em>Target Parameter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParameterBindingImpl extends InteractionFlowModelElementImpl implements ParameterBinding {
			...
			if (sourceParameter != oldSourceParameter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CorePackage.PARAMETER_BINDING__SOURCE_PARAMETER, oldSourceParameter, sourceParameter));
			}
		}
	...
	public void setSourceParameter(IFMLParameter newSourceParameter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.PARAMETER_BINDING__SOURCE_PARAMETER,
	...
	public IFMLParameter getTargetParameter() {
		if (targetParameter != null && targetParameter.eIsProxy()) {
			...
			if (targetParameter != oldTargetParameter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CorePackage.PARAMETER_BINDING__TARGET_PARAMETER, oldTargetParameter, targetParameter));
			}
		}
	...
	public void setTargetParameter(IFMLParameter newTargetParameter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.PARAMETER_BINDING__TARGET_PARAMETER,
