 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.IFMLPortImpl#getPortDefinition <em>Port Definition</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.IFMLPortImpl#getModule <em>Module</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IFMLPortImpl extends InteractionFlowElementImpl implements IFMLPort {
		...
		if (portDefinition != null && portDefinition.eIsProxy()) {
			...
			if (portDefinition != oldPortDefinition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CorePackage.IFML_PORT__PORT_DEFINITION,
	...
	public NotificationChain basicSetPortDefinition(PortDefinition newPortDefinition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CorePackage.IFML_PORT__PORT_DEFINITION, oldPortDefinition, newPortDefinition);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setPortDefinition(PortDefinition newPortDefinition) {
		if (newPortDefinition != portDefinition) {
			...
			if (portDefinition != null)
				msgs = ((InternalEObject) portDefinition).eInverseRemove(this, CorePackage.PORT_DEFINITION__PORTS,
						PortDefinition.class, msgs);
			if (newPortDefinition != null)
				msgs = ((InternalEObject) newPortDefinition).eInverseAdd(this, CorePackage.PORT_DEFINITION__PORTS,
						PortDefinition.class, msgs);
			msgs = basicSetPortDefinition(newPortDefinition, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.IFML_PORT__PORT_DEFINITION,
					newPortDefinition, newPortDefinition));
	}
	...
	public IFMLModule getModule() {
		if (module != null && module.eIsProxy()) {
			...
			if (module != oldModule) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CorePackage.IFML_PORT__MODULE, oldModule,
							module));
			}
		}
		return module;
	...
	public NotificationChain basicSetModule(IFMLModule newModule, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CorePackage.IFML_PORT__MODULE, oldModule, newModule);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setModule(IFMLModule newModule) {
		if (newModule != module) {
			NotificationChain msgs = null;
			if (module != null)
				msgs = ((InternalEObject) module).eInverseRemove(this, CorePackage.IFML_MODULE__PORTS, IFMLModule.class,
						msgs);
			if (newModule != null)
				msgs = ((InternalEObject) newModule).eInverseAdd(this, CorePackage.IFML_MODULE__PORTS, IFMLModule.class,
						msgs);
