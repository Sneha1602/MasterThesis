 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.ModularizationElementImpl#getModulePackage <em>Module Package</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModularizationElementImpl extends NamedElementImpl implements ModularizationElement {
	...
	public ModulePackage getModulePackage() {
		if (eContainerFeatureID() != CorePackage.MODULARIZATION_ELEMENT__MODULE_PACKAGE)
			return null;
	...
	public NotificationChain basicSetModulePackage(ModulePackage newModulePackage, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newModulePackage,
				CorePackage.MODULARIZATION_ELEMENT__MODULE_PACKAGE, msgs);
		return msgs;
	}
	...
	public void setModulePackage(ModulePackage newModulePackage) {
		if (newModulePackage != eInternalContainer()
				|| (eContainerFeatureID() != CorePackage.MODULARIZATION_ELEMENT__MODULE_PACKAGE
						&& newModulePackage != null)) {
			...
			if (newModulePackage != null)
				msgs = ((InternalEObject) newModulePackage).eInverseAdd(this,
						CorePackage.MODULE_PACKAGE__MODULARIZATION_ELEMENTS, ModulePackage.class, msgs);
			msgs = basicSetModulePackage(newModulePackage, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.MODULARIZATION_ELEMENT__MODULE_PACKAGE,
					newModulePackage, newModulePackage));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case CorePackage.MODULARIZATION_ELEMENT__MODULE_PACKAGE:
			return eInternalContainer().eInverseRemove(this, CorePackage.MODULE_PACKAGE__MODULARIZATION_ELEMENTS,
					ModulePackage.class, msgs);
		}
