 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.ModulePackageImpl#getModularizationElements <em>Modularization Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModulePackageImpl extends ModularizationElementImpl implements ModulePackage {
	...
	public EList<ModularizationElement> getModularizationElements() {
		if (modularizationElements == null) {
			modularizationElements = new EObjectContainmentWithInverseEList<ModularizationElement>(
					ModularizationElement.class, this, CorePackage.MODULE_PACKAGE__MODULARIZATION_ELEMENTS,
					CorePackage.MODULARIZATION_ELEMENT__MODULE_PACKAGE);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case CorePackage.MODULE_PACKAGE__MODULARIZATION_ELEMENTS:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getModularizationElements()).basicAdd(otherEnd,
					msgs);
		}
