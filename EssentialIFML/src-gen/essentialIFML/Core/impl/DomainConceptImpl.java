 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.DomainConceptImpl#getDataBinding <em>Data Binding</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DomainConceptImpl extends DomainElementImpl implements DomainConcept {
		...
		if (dataBinding != null && dataBinding.eIsProxy()) {
			...
			if (dataBinding != oldDataBinding) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CorePackage.DOMAIN_CONCEPT__DATA_BINDING,
							oldDataBinding, dataBinding));
			}
		}
		return dataBinding;
	}
	...
	public NotificationChain basicSetDataBinding(DataBinding newDataBinding, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CorePackage.DOMAIN_CONCEPT__DATA_BINDING, oldDataBinding, newDataBinding);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setDataBinding(DataBinding newDataBinding) {
		if (newDataBinding != dataBinding) {
			...
			if (dataBinding != null)
				msgs = ((InternalEObject) dataBinding).eInverseRemove(this, CorePackage.DATA_BINDING__DOMAIN_CONCEPT,
						DataBinding.class, msgs);
			if (newDataBinding != null)
				msgs = ((InternalEObject) newDataBinding).eInverseAdd(this, CorePackage.DATA_BINDING__DOMAIN_CONCEPT,
						DataBinding.class, msgs);
			msgs = basicSetDataBinding(newDataBinding, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.DOMAIN_CONCEPT__DATA_BINDING,
