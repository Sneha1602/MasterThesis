...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Essential IFML Model</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.EssentialIFMLModelImpl#getInteractionFlowModel <em>Interaction Flow Model</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.EssentialIFMLModelImpl#getDomainModel <em>Domain Model</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.EssentialIFMLModelImpl#getInteractionFlowModelViewpoint <em>Interaction Flow Model Viewpoint</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EssentialIFMLModelImpl extends NamedElementImpl implements EssentialIFMLModel {
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.ESSENTIAL_IFML_MODEL;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetInteractionFlowModel(InteractionFlowModel newInteractionFlowModel,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CorePackage.ESSENTIAL_IFML_MODEL__INTERACTION_FLOW_MODEL, oldInteractionFlowModel,
					newInteractionFlowModel);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setInteractionFlowModel(InteractionFlowModel newInteractionFlowModel) {
		if (newInteractionFlowModel != interactionFlowModel) {
			...
			if (interactionFlowModel != null)
				msgs = ((InternalEObject) interactionFlowModel).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CorePackage.ESSENTIAL_IFML_MODEL__INTERACTION_FLOW_MODEL, null, msgs);
			if (newInteractionFlowModel != null)
				msgs = ((InternalEObject) newInteractionFlowModel).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - CorePackage.ESSENTIAL_IFML_MODEL__INTERACTION_FLOW_MODEL, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.ESSENTIAL_IFML_MODEL__INTERACTION_FLOW_MODEL, newInteractionFlowModel,
					newInteractionFlowModel));
	}
	...
	public NotificationChain basicSetDomainModel(DomainModel newDomainModel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CorePackage.ESSENTIAL_IFML_MODEL__DOMAIN_MODEL, oldDomainModel, newDomainModel);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newDomainModel != domainModel) {
			...
			if (domainModel != null)
				msgs = ((InternalEObject) domainModel).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CorePackage.ESSENTIAL_IFML_MODEL__DOMAIN_MODEL, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.ESSENTIAL_IFML_MODEL__DOMAIN_MODEL,
	...
	public EList<Viewpoint> getInteractionFlowModelViewpoint() {
		if (interactionFlowModelViewpoint == null) {
			interactionFlowModelViewpoint = new EObjectContainmentEList<Viewpoint>(Viewpoint.class, this,
					CorePackage.ESSENTIAL_IFML_MODEL__INTERACTION_FLOW_MODEL_VIEWPOINT);
		}
