 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.ElementImpl#getId <em>Id</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.ElementImpl#getConstraints <em>Constraints</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.ElementImpl#getAnnotations <em>Annotations</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public EList<Constraint> getConstraints() {
		if (constraints == null) {
			constraints = new EObjectContainmentEList<Constraint>(Constraint.class, this,
					CorePackage.ELEMENT__CONSTRAINTS);
		}
		return constraints;
	}
	...
	public EList<Annotation> getAnnotations() {
		if (annotations == null) {
			annotations = new EObjectContainmentEList<Annotation>(Annotation.class, this,
					CorePackage.ELEMENT__ANNOTATIONS);
		}
		return annotations;
	}
