 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.ViewContainerImpl#isIsLandmark <em>Is Landmark</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.ViewContainerImpl#isIsDefault <em>Is Default</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.ViewContainerImpl#isIsXOR <em>Is XOR</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.ViewContainerImpl#getViewElements <em>View Elements</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.ViewContainerImpl#getActions <em>Actions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ViewContainerImpl extends ViewElementImpl implements ViewContainer {
	...
	public void setIsLandmark(boolean newIsLandmark) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.VIEW_CONTAINER__IS_LANDMARK,
	...
	public void setIsDefault(boolean newIsDefault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.VIEW_CONTAINER__IS_DEFAULT, oldIsDefault,
					isDefault));
	}
	...
	public EList<ViewElement> getViewElements() {
		if (viewElements == null) {
			viewElements = new EObjectContainmentWithInverseEList<ViewElement>(ViewElement.class, this,
					CorePackage.VIEW_CONTAINER__VIEW_ELEMENTS, CorePackage.VIEW_ELEMENT__VIEW_CONTAINER);
		}
		return viewElements;
	}
	...
	public EList<IFMLAction> getActions() {
		if (actions == null) {
			actions = new EObjectContainmentWithInverseEList<IFMLAction>(IFMLAction.class, this,
					CorePackage.VIEW_CONTAINER__ACTIONS, CorePackage.IFML_ACTION__VIEW_CONTAINER);
		}
		return actions;
	}
