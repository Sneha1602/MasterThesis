 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.ViewElementEventImpl#getViewElement <em>View Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ViewElementEventImpl extends CatchingEventImpl implements ViewElementEvent {
			...
			if (viewElement != oldViewElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CorePackage.VIEW_ELEMENT_EVENT__VIEW_ELEMENT, oldViewElement, viewElement));
			}
		}
		return viewElement;
	}
	...
	public void setViewElement(ViewElement newViewElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.VIEW_ELEMENT_EVENT__VIEW_ELEMENT,
