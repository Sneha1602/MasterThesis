 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.InteractionFlowElementImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.InteractionFlowElementImpl#getOutInteractionFlows <em>Out Interaction Flows</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.InteractionFlowElementImpl#getInInteractionFlows <em>In Interaction Flows</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public EList<IFMLParameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<IFMLParameter>(IFMLParameter.class, this,
					CorePackage.INTERACTION_FLOW_ELEMENT__PARAMETERS);
		}
		return parameters;
	}
	...
	public EList<InteractionFlow> getOutInteractionFlows() {
		if (outInteractionFlows == null) {
			outInteractionFlows = new EObjectContainmentWithInverseEList<InteractionFlow>(InteractionFlow.class, this,
					CorePackage.INTERACTION_FLOW_ELEMENT__OUT_INTERACTION_FLOWS,
	...
	public EList<InteractionFlow> getInInteractionFlows() {
		if (inInteractionFlows == null) {
			inInteractionFlows = new EObjectWithInverseResolvingEList<InteractionFlow>(InteractionFlow.class, this,
					CorePackage.INTERACTION_FLOW_ELEMENT__IN_INTERACTION_FLOWS,
