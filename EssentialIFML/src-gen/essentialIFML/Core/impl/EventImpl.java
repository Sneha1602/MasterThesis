 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.EventImpl#getActivationExpression <em>Activation Expression</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.EventImpl#getInteractionFlowExpression <em>Interaction Flow Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EventImpl extends InteractionFlowElementImpl implements Event {
		...
		if (activationExpression != null && activationExpression.eIsProxy()) {
			...
			if (activationExpression != oldActivationExpression) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CorePackage.EVENT__ACTIVATION_EXPRESSION,
							oldActivationExpression, activationExpression));
			}
		}
	...
	public void setActivationExpression(ActivationExpression newActivationExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.EVENT__ACTIVATION_EXPRESSION,
					oldActivationExpression, activationExpression));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetInteractionFlowExpression(InteractionFlowExpression newInteractionFlowExpression,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CorePackage.EVENT__INTERACTION_FLOW_EXPRESSION, oldInteractionFlowExpression,
					newInteractionFlowExpression);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setInteractionFlowExpression(InteractionFlowExpression newInteractionFlowExpression) {
		if (newInteractionFlowExpression != interactionFlowExpression) {
			...
			if (interactionFlowExpression != null)
				msgs = ((InternalEObject) interactionFlowExpression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CorePackage.EVENT__INTERACTION_FLOW_EXPRESSION, null, msgs);
			if (newInteractionFlowExpression != null)
				msgs = ((InternalEObject) newInteractionFlowExpression).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - CorePackage.EVENT__INTERACTION_FLOW_EXPRESSION, null, msgs);
			msgs = basicSetInteractionFlowExpression(newInteractionFlowExpression, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.EVENT__INTERACTION_FLOW_EXPRESSION,
					newInteractionFlowExpression, newInteractionFlowExpression));
	}
