 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.DataContextVariableImpl#getDataBinding <em>Data Binding</em>}</li>
 * </ul>
 *
 * @generated
 */
			...
			if (dataBinding != oldDataBinding) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CorePackage.DATA_CONTEXT_VARIABLE__DATA_BINDING, oldDataBinding, dataBinding));
			}
		}
		return dataBinding;
	}
	...
	public NotificationChain basicSetDataBinding(DataBinding newDataBinding, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CorePackage.DATA_CONTEXT_VARIABLE__DATA_BINDING, oldDataBinding, newDataBinding);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newDataBinding != dataBinding) {
			...
			if (dataBinding != null)
				msgs = ((InternalEObject) dataBinding).eInverseRemove(this,
						CorePackage.DATA_BINDING__DATA_CONTEXT_VARIABLES, DataBinding.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.DATA_CONTEXT_VARIABLE__DATA_BINDING,
