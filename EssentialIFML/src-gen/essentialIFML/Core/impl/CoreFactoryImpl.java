...
public class CoreFactoryImpl extends EFactoryImpl implements CoreFactory {
	...
	public EObject create(EClass eClass) {
		...
		case CorePackage.ESSENTIAL_IFML_MODEL:
			return createEssentialIFMLModel();
		...
		case CorePackage.SCREEN_ZOOM:
			return createScreenZoom();
		case CorePackage.LIGHT_BACKGROUND_COLOR:
			return createLightBackgroundColor();
	 ...
	 * @generated
	 */
	public ScreenZoom createScreenZoom() {
		ScreenZoomImpl screenZoom = new ScreenZoomImpl();
		return screenZoom;
	}
