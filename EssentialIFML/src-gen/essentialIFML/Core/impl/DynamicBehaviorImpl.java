 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.DynamicBehaviorImpl#getBehavioralFeatureConcept <em>Behavioral Feature Concept</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.DynamicBehaviorImpl#getBehaviorConcept <em>Behavior Concept</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DynamicBehaviorImpl extends ContentBindingImpl implements DynamicBehavior {
			...
			if (behavioralFeatureConcept != oldBehavioralFeatureConcept) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CorePackage.DYNAMIC_BEHAVIOR__BEHAVIORAL_FEATURE_CONCEPT, oldBehavioralFeatureConcept,
	 ...
	 * @generated
	 */
	public NotificationChain basicSetBehavioralFeatureConcept(BehavioralFeatureConcept newBehavioralFeatureConcept,
	...
	public void setBehavioralFeatureConcept(BehavioralFeatureConcept newBehavioralFeatureConcept) {
		if (newBehavioralFeatureConcept != behavioralFeatureConcept) {
			...
			if (behavioralFeatureConcept != null)
				msgs = ((InternalEObject) behavioralFeatureConcept).eInverseRemove(this,
						CorePackage.BEHAVIORAL_FEATURE_CONCEPT__DYNAMIC_BEHAVIOR, BehavioralFeatureConcept.class, msgs);
			if (newBehavioralFeatureConcept != null)
				msgs = ((InternalEObject) newBehavioralFeatureConcept).eInverseAdd(this,
						CorePackage.BEHAVIORAL_FEATURE_CONCEPT__DYNAMIC_BEHAVIOR, BehavioralFeatureConcept.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.DYNAMIC_BEHAVIOR__BEHAVIORAL_FEATURE_CONCEPT, newBehavioralFeatureConcept,
					newBehavioralFeatureConcept));
	}
	...
	public BehaviorConcept getBehaviorConcept() {
		if (behaviorConcept != null && behaviorConcept.eIsProxy()) {
			...
			if (behaviorConcept != oldBehaviorConcept) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CorePackage.DYNAMIC_BEHAVIOR__BEHAVIOR_CONCEPT, oldBehaviorConcept, behaviorConcept));
			}
		}
	...
	public NotificationChain basicSetBehaviorConcept(BehaviorConcept newBehaviorConcept, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CorePackage.DYNAMIC_BEHAVIOR__BEHAVIOR_CONCEPT, oldBehaviorConcept, newBehaviorConcept);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setBehaviorConcept(BehaviorConcept newBehaviorConcept) {
		if (newBehaviorConcept != behaviorConcept) {
			...
			if (behaviorConcept != null)
				msgs = ((InternalEObject) behaviorConcept).eInverseRemove(this,
						CorePackage.BEHAVIOR_CONCEPT__DYNAMIC_BEHAVIOR, BehaviorConcept.class, msgs);
			if (newBehaviorConcept != null)
				msgs = ((InternalEObject) newBehaviorConcept).eInverseAdd(this,
						CorePackage.BEHAVIOR_CONCEPT__DYNAMIC_BEHAVIOR, BehaviorConcept.class, msgs);
			msgs = basicSetBehaviorConcept(newBehaviorConcept, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.DYNAMIC_BEHAVIOR__BEHAVIOR_CONCEPT,
					newBehaviorConcept, newBehaviorConcept));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case CorePackage.DYNAMIC_BEHAVIOR__BEHAVIORAL_FEATURE_CONCEPT:
			if (resolve)
				return getBehavioralFeatureConcept();
			return basicGetBehavioralFeatureConcept();
		case CorePackage.DYNAMIC_BEHAVIOR__BEHAVIOR_CONCEPT:
			if (resolve)
				return getBehaviorConcept();
