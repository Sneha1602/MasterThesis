 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.IFMLModuleImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.IFMLModuleImpl#getOutInteractionFlows <em>Out Interaction Flows</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.IFMLModuleImpl#getInInteractionFlows <em>In Interaction Flows</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.IFMLModuleImpl#getModuleDefinition <em>Module Definition</em>}</li>
 *   <li>{@link essentialIFML.Core.impl.IFMLModuleImpl#getPorts <em>Ports</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IFMLModuleImpl extends NamedElementImpl implements IFMLModule {
	...
	public EList<IFMLParameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<IFMLParameter>(IFMLParameter.class, this,
					CorePackage.IFML_MODULE__PARAMETERS);
		}
		return parameters;
	}
	...
	public EList<InteractionFlow> getOutInteractionFlows() {
		if (outInteractionFlows == null) {
			outInteractionFlows = new EObjectContainmentWithInverseEList<InteractionFlow>(InteractionFlow.class, this,
					CorePackage.IFML_MODULE__OUT_INTERACTION_FLOWS,
	...
	public EList<InteractionFlow> getInInteractionFlows() {
		if (inInteractionFlows == null) {
			inInteractionFlows = new EObjectWithInverseResolvingEList<InteractionFlow>(InteractionFlow.class, this,
					CorePackage.IFML_MODULE__IN_INTERACTION_FLOWS,
			...
			if (moduleDefinition != oldModuleDefinition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CorePackage.IFML_MODULE__MODULE_DEFINITION, oldModuleDefinition, moduleDefinition));
			}
		}
	...
	public NotificationChain basicSetModuleDefinition(ModuleDefinition newModuleDefinition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CorePackage.IFML_MODULE__MODULE_DEFINITION, oldModuleDefinition, newModuleDefinition);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setModuleDefinition(ModuleDefinition newModuleDefinition) {
		if (newModuleDefinition != moduleDefinition) {
			...
			if (moduleDefinition != null)
				msgs = ((InternalEObject) moduleDefinition).eInverseRemove(this, CorePackage.MODULE_DEFINITION__MODULES,
						ModuleDefinition.class, msgs);
			if (newModuleDefinition != null)
				msgs = ((InternalEObject) newModuleDefinition).eInverseAdd(this, CorePackage.MODULE_DEFINITION__MODULES,
						ModuleDefinition.class, msgs);
			msgs = basicSetModuleDefinition(newModuleDefinition, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.IFML_MODULE__MODULE_DEFINITION,
	...
	public EList<IFMLPort> getPorts() {
		if (ports == null) {
			ports = new EObjectWithInverseResolvingEList<IFMLPort>(IFMLPort.class, this, CorePackage.IFML_MODULE__PORTS,
					CorePackage.IFML_PORT__MODULE);
		}
		return ports;
	}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == InteractionFlowElement.class) {
			...
			case CorePackage.INTERACTION_FLOW_ELEMENT__PARAMETERS:
				return CorePackage.IFML_MODULE__PARAMETERS;
			case CorePackage.INTERACTION_FLOW_ELEMENT__OUT_INTERACTION_FLOWS:
				return CorePackage.IFML_MODULE__OUT_INTERACTION_FLOWS;
			case CorePackage.INTERACTION_FLOW_ELEMENT__IN_INTERACTION_FLOWS:
				return CorePackage.IFML_MODULE__IN_INTERACTION_FLOWS;
			default:
				return -1;
			}
		}
