 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.impl.UMLStructuralFeatureImpl#getStructuralFeature <em>Structural Feature</em>}</li>
 * </ul>
 *
 * @generated
 */
			...
			if (structuralFeature != oldStructuralFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CorePackage.UML_STRUCTURAL_FEATURE__STRUCTURAL_FEATURE, oldStructuralFeature,
							structuralFeature));
			}
		}
	...
	public void setStructuralFeature(StructuralFeature newStructuralFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.UML_STRUCTURAL_FEATURE__STRUCTURAL_FEATURE, oldStructuralFeature, structuralFeature));
	}
