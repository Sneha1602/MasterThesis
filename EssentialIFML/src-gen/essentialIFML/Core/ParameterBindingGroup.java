 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.ParameterBindingGroup#getParameterBindings <em>Parameter Bindings</em>}</li>
 * </ul>
 *
 * @see essentialIFML.Core.CorePackage#getParameterBindingGroup()
 * @model
 * @generated
 */
public interface ParameterBindingGroup extends InteractionFlowModelElement {
	 ...
	 * The list contents are of type {@link essentialIFML.Core.ParameterBinding}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see essentialIFML.Core.CorePackage#getParameterBindingGroup_ParameterBindings()
