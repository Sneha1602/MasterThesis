 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Core.IFMLModel#getInteractionFlowModel <em>Interaction Flow Model</em>}</li>
 *   <li>{@link essentialIFML.Core.IFMLModel#getDomainModel <em>Domain Model</em>}</li>
 *   <li>{@link essentialIFML.Core.IFMLModel#getInteractionFlowModelViewpoint <em>Interaction Flow Model Viewpoint</em>}</li>
 * </ul>
 *
 * @see essentialIFML.Core.CorePackage#getIFMLModel()
 * @model
 * @generated
 */
public interface IFMLModel extends NamedElement {
	 ...
	 * @see essentialIFML.Core.CorePackage#getIFMLModel_InteractionFlowModel()
	...
	/**
	 * Sets the value of the '{@link essentialIFML.Core.IFMLModel#getInteractionFlowModel <em>Interaction Flow Model</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see essentialIFML.Core.CorePackage#getIFMLModel_DomainModel()
	 * @model containment="true" required="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link essentialIFML.Core.IFMLModel#getDomainModel <em>Domain Model</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see essentialIFML.Core.CorePackage#getIFMLModel_InteractionFlowModelViewpoint()
