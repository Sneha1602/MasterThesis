...
import essentialIFML.Core.impl.ThrowingEventImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Extensions.impl.JumpEventImpl#getLandingEvent <em>Landing Event</em>}</li>
 * </ul>
 *
 * @generated
 */
			...
			if (landingEvent != oldLandingEvent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ExtensionsPackage.JUMP_EVENT__LANDING_EVENT, oldLandingEvent, landingEvent));
			}
		}
		return landingEvent;
	}
	...
	public NotificationChain basicSetLandingEvent(LandingEvent newLandingEvent, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ExtensionsPackage.JUMP_EVENT__LANDING_EVENT, oldLandingEvent, newLandingEvent);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setLandingEvent(LandingEvent newLandingEvent) {
		if (newLandingEvent != landingEvent) {
			...
			if (landingEvent != null)
				msgs = ((InternalEObject) landingEvent).eInverseRemove(this,
						ExtensionsPackage.LANDING_EVENT__JUMPING_EVENTS, LandingEvent.class, msgs);
			if (newLandingEvent != null)
				msgs = ((InternalEObject) newLandingEvent).eInverseAdd(this,
						ExtensionsPackage.LANDING_EVENT__JUMPING_EVENTS, LandingEvent.class, msgs);
			msgs = basicSetLandingEvent(newLandingEvent, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtensionsPackage.JUMP_EVENT__LANDING_EVENT,
					newLandingEvent, newLandingEvent));
	}
