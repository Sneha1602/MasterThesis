...
import essentialIFML.Core.impl.CatchingEventImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Extensions.impl.LandingEventImpl#getJumpingEvents <em>Jumping Events</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LandingEventImpl extends CatchingEventImpl implements LandingEvent {
	...
	public EList<JumpEvent> getJumpingEvents() {
		if (jumpingEvents == null) {
			jumpingEvents = new EObjectWithInverseResolvingEList<JumpEvent>(JumpEvent.class, this,
					ExtensionsPackage.LANDING_EVENT__JUMPING_EVENTS, ExtensionsPackage.JUMP_EVENT__LANDING_EVENT);
		}
