 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Extensions.impl.FieldImpl#getDirection <em>Direction</em>}</li>
 *   <li>{@link essentialIFML.Extensions.impl.FieldImpl#getDefaultValue <em>Default Value</em>}</li>
 *   <li>{@link essentialIFML.Extensions.impl.FieldImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class FieldImpl extends ViewComponentPartImpl implements Field {
	...
	public void setDirection(Direction newDirection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtensionsPackage.FIELD__DIRECTION, oldDirection,
					direction));
	}
	...
	public Expression getDefaultValue() {
		if (defaultValue != null && defaultValue.eIsProxy()) {
			...
			if (defaultValue != oldDefaultValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ExtensionsPackage.FIELD__DEFAULT_VALUE,
	...
	public void setDefaultValue(Expression newDefaultValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtensionsPackage.FIELD__DEFAULT_VALUE,
					oldDefaultValue, defaultValue));
	}
	...
	public Type getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ExtensionsPackage.FIELD__TYPE, oldType,
							type));
			}
		}
		return type;
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == IFMLParameter.class) {
			...
			case CorePackage.IFML_PARAMETER__DIRECTION:
				return ExtensionsPackage.FIELD__DIRECTION;
			case CorePackage.IFML_PARAMETER__DEFAULT_VALUE:
				return ExtensionsPackage.FIELD__DEFAULT_VALUE;
			case CorePackage.IFML_PARAMETER__TYPE:
				return ExtensionsPackage.FIELD__TYPE;
			default:
				return -1;
			}
		}
