...
import essentialIFML.Core.impl.ViewComponentPartImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Extensions.impl.IFMLSlotImpl#getDirection <em>Direction</em>}</li>
 *   <li>{@link essentialIFML.Extensions.impl.IFMLSlotImpl#getDefaultValue <em>Default Value</em>}</li>
 *   <li>{@link essentialIFML.Extensions.impl.IFMLSlotImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IFMLSlotImpl extends ViewComponentPartImpl implements IFMLSlot {
	...
	public void setDirection(Direction newDirection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtensionsPackage.IFML_SLOT__DIRECTION, oldDirection,
					direction));
	}
			...
			if (defaultValue != oldDefaultValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ExtensionsPackage.IFML_SLOT__DEFAULT_VALUE, oldDefaultValue, defaultValue));
			}
		}
		return defaultValue;
	}
	...
	public void setDefaultValue(Expression newDefaultValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtensionsPackage.IFML_SLOT__DEFAULT_VALUE,
	...
	public Type getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ExtensionsPackage.IFML_SLOT__TYPE,
							oldType, type));
			}
		}
		return type;
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == IFMLParameter.class) {
			...
			case ExtensionsPackage.IFML_SLOT__DIRECTION:
				return CorePackage.IFML_PARAMETER__DIRECTION;
			case ExtensionsPackage.IFML_SLOT__DEFAULT_VALUE:
				return CorePackage.IFML_PARAMETER__DEFAULT_VALUE;
			case ExtensionsPackage.IFML_SLOT__TYPE:
				return CorePackage.IFML_PARAMETER__TYPE;
			default:
				return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == IFMLParameter.class) {
			...
			case CorePackage.IFML_PARAMETER__DIRECTION:
				return ExtensionsPackage.IFML_SLOT__DIRECTION;
			case CorePackage.IFML_PARAMETER__DEFAULT_VALUE:
				return ExtensionsPackage.IFML_SLOT__DEFAULT_VALUE;
			case CorePackage.IFML_PARAMETER__TYPE:
				return ExtensionsPackage.IFML_SLOT__TYPE;
			default:
				return -1;
			}
		}
