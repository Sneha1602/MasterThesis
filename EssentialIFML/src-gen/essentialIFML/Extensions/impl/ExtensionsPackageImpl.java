...
import essentialIFML.Core.impl.CorePackageImpl;
...
import essentialIFML.Extensions.Position;
import essentialIFML.Extensions.SelectionField;
import essentialIFML.Extensions.SetContextEvent;
import essentialIFML.Extensions.SimpleField;
import essentialIFML.Extensions.UserRole;
import essentialIFML.Extensions.ValidationRule;
...
public class ExtensionsPackageImpl extends EPackageImpl implements ExtensionsPackage {
	 ...
	 * @see essentialIFML.Extensions.ExtensionsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static ExtensionsPackage init() {
		...
		ExtensionsPackageImpl theExtensionsPackage = (ExtensionsPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof ExtensionsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
	...
	public void initializePackageContents() {
		...
		initEClass(onSubmitEventEClass, OnSubmitEvent.class, "OnSubmitEvent", !IS_ABSTRACT, !IS_INTERFACE,
		...
		initEReference(getList_SelectEvent(), this.getOnSelectEvent(), null, "selectEvent", null, 0, -1, List.class,
		...
		initEClass(ifmlSlotEClass, IFMLSlot.class, "IFMLSlot", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(onSelectEventEClass, OnSelectEvent.class, "OnSelectEvent", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		...
		initEClass(selectionFieldEClass, SelectionField.class, "SelectionField", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSelectionField_IsMultiSelection(), ecorePackage.getEBoolean(), "isMultiSelection", null, 1, 1,
				SelectionField.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, !IS_ORDERED);

		initEClass(simpleFieldEClass, SimpleField.class, "SimpleField", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(detailsEClass, Details.class, "Details", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(ifmlWindowEClass, IFMLWindow.class, "IFMLWindow", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getIFMLWindow_IsModal(), ecorePackage.getEBoolean(), "isModal", null, 1, 1, IFMLWindow.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEAttribute(getIFMLWindow_IsNewWindow(), ecorePackage.getEBoolean(), "isNewWindow", null, 1, 1,
				IFMLWindow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, !IS_ORDERED);

		initEClass(onLoadEventEClass, OnLoadEvent.class, "OnLoadEvent", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(ifmlMenuEClass, IFMLMenu.class, "IFMLMenu", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(jumpEventEClass, JumpEvent.class, "JumpEvent", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getJumpEvent_LandingEvent(), this.getLandingEvent(), this.getLandingEvent_JumpingEvents(),
				"landingEvent", null, 0, 1, JumpEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(landingEventEClass, LandingEvent.class, "LandingEvent", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getLandingEvent_JumpingEvents(), this.getJumpEvent(), this.getJumpEvent_LandingEvent(),
				"jumpingEvents", null, 0, -1, LandingEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(setContextEventEClass, SetContextEvent.class, "SetContextEvent", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
