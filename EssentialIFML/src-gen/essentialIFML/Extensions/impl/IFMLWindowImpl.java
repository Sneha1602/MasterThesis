 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Extensions.impl.IFMLWindowImpl#isIsModal <em>Is Modal</em>}</li>
 *   <li>{@link essentialIFML.Extensions.impl.IFMLWindowImpl#isIsNewWindow <em>Is New Window</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IFMLWindowImpl extends ViewContainerImpl implements IFMLWindow {
	...
	public void setIsModal(boolean newIsModal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtensionsPackage.IFML_WINDOW__IS_MODAL, oldIsModal,
					isModal));
	}
	...
	public void setIsNewWindow(boolean newIsNewWindow) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtensionsPackage.IFML_WINDOW__IS_NEW_WINDOW,
