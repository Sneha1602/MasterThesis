 ...
 * </p>
 * <ul>
 *   <li>{@link essentialIFML.Extensions.impl.SelectionFieldImpl#isIsMultiSelection <em>Is Multi Selection</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SelectionFieldImpl extends FieldImpl implements SelectionField {
	...
	public void setIsMultiSelection(boolean newIsMultiSelection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtensionsPackage.SELECTION_FIELD__IS_MULTI_SELECTION,
					oldIsMultiSelection, isMultiSelection));
	}
