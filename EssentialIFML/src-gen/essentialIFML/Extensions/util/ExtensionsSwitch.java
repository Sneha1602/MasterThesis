...
public class ExtensionsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ExtensionsPackage.ON_SUBMIT_EVENT: {
			...
			if (result == null)
				result = caseViewElementEvent(onSubmitEvent);
			if (result == null)
				result = caseCatchingEvent(onSubmitEvent);
			if (result == null)
				result = caseEvent(onSubmitEvent);
			if (result == null)
				result = caseInteractionFlowElement(onSubmitEvent);
			if (result == null)
				result = caseNamedElement(onSubmitEvent);
			if (result == null)
				result = caseInteractionFlowModelElement(onSubmitEvent);
			if (result == null)
				result = caseElement(onSubmitEvent);
			if (result == null)
		...
		case ExtensionsPackage.VALIDATION_RULE: {
			...
			if (result == null)
				result = caseConstraint(validationRule);
			if (result == null)
				result = caseBooleanExpression(validationRule);
			if (result == null)
				result = caseExpression(validationRule);
			if (result == null)
				result = caseInteractionFlowModelElement(validationRule);
			if (result == null)
				result = caseElement(validationRule);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ExtensionsPackage.LIST: {
			...
			if (result == null)
				result = caseViewComponent(list);
			if (result == null)
				result = caseViewElement(list);
			if (result == null)
				result = caseInteractionFlowElement(list);
			if (result == null)
				result = caseNamedElement(list);
			if (result == null)
				result = caseInteractionFlowModelElement(list);
			if (result == null)
		...
		case ExtensionsPackage.POSITION: {
			...
			if (result == null)
				result = caseContextDimension(position);
			if (result == null)
				result = caseNamedElement(position);
			if (result == null)
				result = caseElement(position);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ExtensionsPackage.USER_ROLE: {
			...
			if (result == null)
				result = caseContextDimension(userRole);
			if (result == null)
				result = caseNamedElement(userRole);
			if (result == null)
				result = caseElement(userRole);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ExtensionsPackage.IFML_SLOT: {
			...
			if (result == null)
				result = caseViewComponentPart(ifmlSlot);
			if (result == null)
				result = caseIFMLParameter(ifmlSlot);
			if (result == null)
				result = caseInteractionFlowElement(ifmlSlot);
			if (result == null)
				result = caseNamedElement(ifmlSlot);
			if (result == null)
				result = caseInteractionFlowModelElement(ifmlSlot);
			if (result == null)
				result = caseElement(ifmlSlot);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ExtensionsPackage.ON_SELECT_EVENT: {
			...
			if (result == null)
				result = caseViewElementEvent(onSelectEvent);
			if (result == null)
				result = caseCatchingEvent(onSelectEvent);
			if (result == null)
				result = caseEvent(onSelectEvent);
			if (result == null)
				result = caseInteractionFlowElement(onSelectEvent);
			if (result == null)
				result = caseNamedElement(onSelectEvent);
			if (result == null)
				result = caseInteractionFlowModelElement(onSelectEvent);
			if (result == null)
				result = caseElement(onSelectEvent);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ExtensionsPackage.FIELD: {
			...
			if (result == null)
				result = caseViewComponentPart(field);
			if (result == null)
				result = caseIFMLParameter(field);
			if (result == null)
				result = caseInteractionFlowElement(field);
			if (result == null)
				result = caseNamedElement(field);
			if (result == null)
				result = caseInteractionFlowModelElement(field);
			if (result == null)
		...
		case ExtensionsPackage.FORM: {
			...
			if (result == null)
				result = caseViewComponent(form);
			if (result == null)
				result = caseViewElement(form);
			if (result == null)
				result = caseInteractionFlowElement(form);
			if (result == null)
				result = caseNamedElement(form);
			if (result == null)
				result = caseInteractionFlowModelElement(form);
			if (result == null)
				result = caseElement(form);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ExtensionsPackage.DEVICE: {
			...
			if (result == null)
				result = caseContextDimension(device);
			if (result == null)
		...
		case ExtensionsPackage.SELECTION_FIELD: {
			...
			if (result == null)
				result = caseField(selectionField);
			if (result == null)
				result = caseViewComponentPart(selectionField);
			if (result == null)
				result = caseIFMLParameter(selectionField);
			if (result == null)
				result = caseInteractionFlowElement(selectionField);
			if (result == null)
				result = caseNamedElement(selectionField);
			if (result == null)
				result = caseInteractionFlowModelElement(selectionField);
			if (result == null)
				result = caseElement(selectionField);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ExtensionsPackage.SIMPLE_FIELD: {
			...
			if (result == null)
				result = caseField(simpleField);
			if (result == null)
				result = caseViewComponentPart(simpleField);
			if (result == null)
				result = caseIFMLParameter(simpleField);
			if (result == null)
				result = caseInteractionFlowElement(simpleField);
			if (result == null)
				result = caseNamedElement(simpleField);
			if (result == null)
				result = caseInteractionFlowModelElement(simpleField);
			if (result == null)
				result = caseElement(simpleField);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ExtensionsPackage.DETAILS: {
			...
			if (result == null)
				result = caseViewComponent(details);
			if (result == null)
				result = caseViewElement(details);
			if (result == null)
				result = caseInteractionFlowElement(details);
			if (result == null)
				result = caseNamedElement(details);
			if (result == null)
				result = caseInteractionFlowModelElement(details);
			if (result == null)
				result = caseElement(details);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ExtensionsPackage.IFML_WINDOW: {
			...
			if (result == null)
				result = caseViewContainer(ifmlWindow);
			if (result == null)
				result = caseViewElement(ifmlWindow);
			if (result == null)
				result = caseInteractionFlowElement(ifmlWindow);
			if (result == null)
				result = caseNamedElement(ifmlWindow);
			if (result == null)
				result = caseInteractionFlowModelElement(ifmlWindow);
			if (result == null)
				result = caseElement(ifmlWindow);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ExtensionsPackage.ON_LOAD_EVENT: {
			...
			if (result == null)
				result = caseSystemEvent(onLoadEvent);
			if (result == null)
				result = caseCatchingEvent(onLoadEvent);
			if (result == null)
				result = caseEvent(onLoadEvent);
			if (result == null)
				result = caseInteractionFlowElement(onLoadEvent);
			if (result == null)
				result = caseNamedElement(onLoadEvent);
			if (result == null)
				result = caseInteractionFlowModelElement(onLoadEvent);
			if (result == null)
				result = caseElement(onLoadEvent);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ExtensionsPackage.IFML_MENU: {
			...
			if (result == null)
				result = caseViewContainer(ifmlMenu);
			if (result == null)
				result = caseViewElement(ifmlMenu);
			if (result == null)
				result = caseInteractionFlowElement(ifmlMenu);
			if (result == null)
				result = caseNamedElement(ifmlMenu);
			if (result == null)
				result = caseInteractionFlowModelElement(ifmlMenu);
			if (result == null)
				result = caseElement(ifmlMenu);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ExtensionsPackage.JUMP_EVENT: {
			...
			if (result == null)
				result = caseThrowingEvent(jumpEvent);
			if (result == null)
				result = caseEvent(jumpEvent);
			if (result == null)
				result = caseInteractionFlowElement(jumpEvent);
			if (result == null)
				result = caseNamedElement(jumpEvent);
			if (result == null)
				result = caseInteractionFlowModelElement(jumpEvent);
			if (result == null)
				result = caseElement(jumpEvent);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ExtensionsPackage.LANDING_EVENT: {
			...
			if (result == null)
				result = caseCatchingEvent(landingEvent);
			if (result == null)
				result = caseEvent(landingEvent);
			if (result == null)
				result = caseInteractionFlowElement(landingEvent);
			if (result == null)
				result = caseNamedElement(landingEvent);
			if (result == null)
				result = caseInteractionFlowModelElement(landingEvent);
			if (result == null)
				result = caseElement(landingEvent);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ExtensionsPackage.SET_CONTEXT_EVENT: {
			...
			if (result == null)
				result = caseThrowingEvent(setContextEvent);
			if (result == null)
				result = caseEvent(setContextEvent);
			if (result == null)
				result = caseInteractionFlowElement(setContextEvent);
			if (result == null)
				result = caseNamedElement(setContextEvent);
			if (result == null)
				result = caseInteractionFlowModelElement(setContextEvent);
			if (result == null)
				result = caseElement(setContextEvent);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
