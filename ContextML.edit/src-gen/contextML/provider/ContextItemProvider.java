...
public class ContextItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Context_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Context_name_feature", "_UI_Context_type"),
						ContextMLPackage.Literals.CONTEXT__NAME, true, false, false,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ContextMLPackage.Literals.CONTEXT__ENTITY,
		...
		newChildDescriptors.add(createChildParameter(ContextMLPackage.Literals.CONTEXT__PROVIDER,
